...
Public Class RadialGridDemo
    ...
    Private Const AppTitle As String = "MHydrax RadialGridDemo"
    ...
    Public Sub CreateScene()
        ...
        ' Create our radial grid module
        Dim m As New MHydrax.MRadialGrid(hydrax, _
        ...
        hydrax.LoadCfg("RadialGridDemo.hdx")
