...
namespace Mogre
{
	...
	public:
		...
		void ApplyToNode( Mogre::Node^ node, Mogre::Real timePos, Mogre::Real weight, Mogre::Real scale );
		void ApplyToNode( Mogre::Node^ node, Mogre::Real timePos, Mogre::Real weight );
		void ApplyToNode( Mogre::Node^ node, Mogre::Real timePos );
		...
		void Apply( Mogre::Skeleton^ skeleton, Mogre::Real timePos, float weight, Mogre::AnimationState::Const_BoneBlendMask^ blendMask, Mogre::Real scale );
	
		void Apply( Mogre::Entity^ entity, Mogre::Real timePos, Mogre::Real weight, bool software, bool hardware );
	
		void ApplyToAnimable( Mogre::AnimableValuePtr^ anim, Mogre::Real timePos, Mogre::Real weight, Mogre::Real scale );
		void ApplyToAnimable( Mogre::AnimableValuePtr^ anim, Mogre::Real timePos, Mogre::Real weight );
		void ApplyToAnimable( Mogre::AnimableValuePtr^ anim, Mogre::Real timePos );
	
		void ApplyToVertexData( Mogre::VertexData^ data, Mogre::Real timePos, Mogre::Real weight );
		void ApplyToVertexData( Mogre::VertexData^ data, Mogre::Real timePos );
