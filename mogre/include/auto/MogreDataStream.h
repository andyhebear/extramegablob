...
namespace Mogre
{
	...
	public ref class DataStream
	{
		...
		{
			READ = Ogre::DataStream::READ,
			WRITE = Ogre::DataStream::WRITE
		};
	...
	public:
		...
		property Mogre::uchar* CurrentPtr
		{
		public:
			Mogre::uchar* get();
		}
	
		property Mogre::uchar* Ptr
		{
		public:
			Mogre::uchar* get();
		}
	...
	INC_DECLARE_STLLIST( DataStreamList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE, public, private )
