...
namespace Mogre
{
	...
	public ref class Material : public Resource
	{
		...
		public: INC_DECLARE_ITERATOR( LodValueIterator, Ogre::Material::LodValueIterator, Mogre::Material::LodValueList, Mogre::Real, Ogre::Real )
	...
	public:
		...
		Mogre::Technique^ GetBestTechnique( unsigned short lodIndex, Mogre::IRenderable^ rend );
		...
		void SetLodLevels( Mogre::Material::Const_LodValueList^ lodValues );
	
		Mogre::Material::LodValueIterator^ GetLodValueIterator( );
