...
namespace Mogre
{
	...
	{
		//Nested Types
		public: ref class LodValueList;
		public: ref class MeshLodUsageList;
		...
		public: INC_DECLARE_STLVECTOR( LodValueList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE, public: , private: )
		#undef STLDECL_MANAGEDTYPE
		#undef STLDECL_NATIVETYPE
	
		#define STLDECL_MANAGEDTYPE Mogre::MeshLodUsage^
		#define STLDECL_NATIVETYPE Ogre::MeshLodUsage
		public: INC_DECLARE_STLVECTOR( MeshLodUsageList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE, public: , private: )
		#undef STLDECL_MANAGEDTYPE
		#undef STLDECL_NATIVETYPE
	...
	public:
		...
		property Mogre::LodStrategy^ LodStrategy
		{
		public:
			Mogre::LodStrategy^ get();
		public:
			void set(Mogre::LodStrategy^ lodStrategy);
		}
		...
		Mogre::Mesh::Const_VertexBoneAssignmentList^ GetBoneAssignments( );
	
		void GenerateLodLevels( Mogre::Mesh::Const_LodValueList^ lodValues, Mogre::ProgressiveMesh::VertexReductionQuota reductionMethod, Mogre::Real reductionValue );
	
		Mogre::MeshLodUsage^ GetLodLevel( Mogre::ushort index );
	
		void CreateManualLodLevel( Mogre::Real value, String^ meshName, String^ groupName );
		void CreateManualLodLevel( Mogre::Real value, String^ meshName );
	
		void UpdateManualLodLevel( Mogre::ushort index, String^ meshName );
	
		Mogre::ushort GetLodIndex( Mogre::Real value );
		...
		void BuildTangentVectors( Mogre::VertexElementSemantic targetSemantic, unsigned short sourceTexCoordSet, unsigned short index, bool splitMirrored, bool splitRotated, bool storeParityInW );
		void BuildTangentVectors( Mogre::VertexElementSemantic targetSemantic, unsigned short sourceTexCoordSet, unsigned short index, bool splitMirrored, bool splitRotated );
		void BuildTangentVectors( Mogre::VertexElementSemantic targetSemantic, unsigned short sourceTexCoordSet, unsigned short index, bool splitMirrored );
		...
		Mogre::EdgeData^ GetEdgeList( unsigned short lodIndex );
