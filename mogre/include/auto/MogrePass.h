...
namespace Mogre
{
	...
	public:
		...
		property Mogre::SceneBlendFactor DestBlendFactorAlpha
		{
		public:
			Mogre::SceneBlendFactor get();
		}
		...
		property String^ GeometryProgramName
		{
		public:
			String^ get();
		}
		...
		property bool HasGeometryProgram
		{
		public:
			bool get();
		}
		...
		property bool HasSeparateSceneBlending
		{
		public:
			bool get();
		}
	
		property bool HasSeparateSceneBlendingOperations
		{
		public:
			bool get();
		}
		...
		property Mogre::IlluminationStage IlluminationStage
		{
		public:
			Mogre::IlluminationStage get();
		public:
			void set(Mogre::IlluminationStage is);
		}
		...
		property float IterationDepthBias
		{
		public:
			float get();
		public:
			void set(float biasPerIteration);
		}
	
		property bool LightClipPlanesEnabled
		{
		public:
			bool get();
		public:
		...
		property bool LightScissoringEnabled
		{
		public:
			bool get();
		public:
		...
		property Mogre::SceneBlendOperation SceneBlendingOperation
		{
		public:
			Mogre::SceneBlendOperation get();
		public:
			void set(Mogre::SceneBlendOperation op);
		}
	
		property Mogre::SceneBlendOperation SceneBlendingOperationAlpha
		{
		public:
			Mogre::SceneBlendOperation get();
		}
		...
		property Mogre::SceneBlendFactor SourceBlendFactorAlpha
		{
		public:
			Mogre::SceneBlendFactor get();
		}
		...
		property bool TransparentSortingEnabled
		{
		public:
			bool get();
		public:
		...
		property bool TransparentSortingForced
		{
		public:
			bool get();
		public:
		...
		void SetSeparateSceneBlendingOperation( Mogre::SceneBlendOperation op, Mogre::SceneBlendOperation alphaOp );
		...
		void SetAlphaRejectSettings( Mogre::CompareFunction func, unsigned char value, bool alphaToCoverageEnabled );
		...
		void SetGeometryProgram( String^ name, bool resetParams );
		void SetGeometryProgram( String^ name );
	
		void SetGeometryProgramParameters( Mogre::GpuProgramParametersSharedPtr^ params );
	
		Mogre::GpuProgramParametersSharedPtr^ GetGeometryProgramParameters( );
	
		Mogre::GpuProgramPtr^ GetGeometryProgram( );
