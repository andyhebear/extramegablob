...
namespace Mogre
{
	...
	public:
		...
		void Merge( Mogre::QueuedRenderableCollection^ rhs );
	...
	public:
		...
		property Mogre::QueuedRenderableCollection^ TransparentsUnsorted
		{
		public:
			Mogre::QueuedRenderableCollection^ get();
		}
		...
		void Merge( Mogre::RenderPriorityGroup^ rhs );
	...
	public:
		...
		void Merge( Mogre::RenderQueueGroup^ rhs );
	...
	public:
		...
		virtual void visit( Ogre::RenderablePass* rp ) override;
	
		virtual bool visit( const Ogre::Pass* p ) override;
	
		virtual void visit( Ogre::Renderable* r ) override;
	};
