...
namespace Mogre
{
	...
	public ref class RenderTarget : public Wrapper, public IRenderTargetListener_Receiver
	{
		...
		public: enum class FrameBuffer
		{
			FB_FRONT = Ogre::RenderTarget::FB_FRONT,
			FB_BACK = Ogre::RenderTarget::FB_BACK,
			FB_AUTO = Ogre::RenderTarget::FB_AUTO
		};
	...
	public:
		...
		property Mogre::uint FSAA
		{
		public:
			Mogre::uint get();
		}
	
		property String^ FSAAHint
		{
		public:
			String^ get();
		}
		...
		property bool IsHardwareGammaEnabled
		{
		public:
			bool get();
		}
		...
		void CopyContentsToMemory( Mogre::PixelBox dst );
		...
		void _updateViewport( int zorder, bool updateStatistics );
		void _updateViewport( int zorder );
	
		void _updateViewport( Mogre::Viewport^ viewport, bool updateStatistics );
		void _updateViewport( Mogre::Viewport^ viewport );
	
		void _updateAutoUpdatedViewports( bool updateStatistics );
		void _updateAutoUpdatedViewports( );
