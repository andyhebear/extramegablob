...
namespace Mogre
{
	...
	public ref class ResourceManager
	{
		...
		public: ref class ResourceWithGroupMap;
		...
		public: INC_DECLARE_STLHASHMAP( ResourceWithGroupMap, STLDECL_MANAGEDKEY, STLDECL_MANAGEDVALUE, STLDECL_NATIVEKEY, STLDECL_NATIVEVALUE, public: , private: )
		#undef STLDECL_MANAGEDKEY
		#undef STLDECL_MANAGEDVALUE
		#undef STLDECL_NATIVEKEY
		#undef STLDECL_NATIVEVALUE
	...
	public:
		...
		Mogre::ResourcePtr^ GetByName( String^ name, String^ groupName );
		...
		Mogre::ResourcePtr^ Prepare( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ loadParams, bool backgroundThread );
		Mogre::ResourcePtr^ Prepare( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ loadParams );
		Mogre::ResourcePtr^ Prepare( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader );
		Mogre::ResourcePtr^ Prepare( String^ name, String^ group, bool isManual );
		Mogre::ResourcePtr^ Prepare( String^ name, String^ group );
	
		Mogre::ResourcePtr^ Load( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ loadParams, bool backgroundThread );
