...
namespace Mogre
{
	...
	public ref class StaticGeometry : public Wrapper
	{
		...
		public protected:
			...
			//Public Declarations
		public:
			LODBucket( Mogre::StaticGeometry::Region^ parent, unsigned short lod, Mogre::Real lodValue );
			...
			property bool IsVertexProgramInUse
			{
			public:
				bool get();
			}
			...
			void AddRenderables( Mogre::RenderQueue^ queue, Mogre::uint8 group, Mogre::Real lodValue );
	
			Mogre::StaticGeometry::LODBucket::MaterialIterator^ GetMaterialIterator( );
	
			void Dump( [Out] std::ofstream% of );
	
			Mogre::ShadowCaster::ShadowRenderableList^ GetShadowRenderableList( );
	
			void UpdateShadowRenderables( Mogre::ShadowTechnique shadowTechnique, Mogre::Vector4 lightPos, Mogre::HardwareIndexBufferSharedPtr^ indexBuffer, bool extrudeVertices, Mogre::Real extrusionDistance, unsigned long flags );
			void UpdateShadowRenderables( Mogre::ShadowTechnique shadowTechnique, Mogre::Vector4 lightPos, Mogre::HardwareIndexBufferSharedPtr^ indexBuffer, bool extrudeVertices, Mogre::Real extrusionDistance );
