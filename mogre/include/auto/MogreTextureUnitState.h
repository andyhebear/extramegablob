...
namespace Mogre
{
	...
	public:
		...
		property String^ ReferencedCompositorName
		{
		public:
			String^ get();
		}
	
		property size_t ReferencedMRTIndex
		{
		public:
			size_t get();
		}
	
		property String^ ReferencedTextureName
		{
		public:
			String^ get();
		}
		...
		void SetCompositorReference( String^ compositorName, String^ textureName, size_t mrtIndex );
		void SetCompositorReference( String^ compositorName, String^ textureName );
