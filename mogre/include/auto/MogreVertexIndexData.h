...
namespace Mogre
{
	...
	public:
		VertexData( );
		VertexData( Mogre::VertexDeclaration^ dcl, Mogre::VertexBufferBinding^ bind );
		...
		property bool mDeleteDclBinding
		{
		public:
			bool get();
		public:
		...
		Mogre::VertexData^ Clone( bool copyData, Mogre::HardwareBufferManagerBase^ mgr );
		Mogre::VertexData^ Clone( bool copyData );
		Mogre::VertexData^ Clone( );
	
		void PrepareForShadowVolume( );
	
		void ReorganiseBuffers( Mogre::VertexDeclaration^ newDeclaration, Mogre::Const_BufferUsageList^ bufferUsage, Mogre::HardwareBufferManagerBase^ mgr );
		void ReorganiseBuffers( Mogre::VertexDeclaration^ newDeclaration, Mogre::Const_BufferUsageList^ bufferUsage );
	
		void ReorganiseBuffers( Mogre::VertexDeclaration^ newDeclaration, Mogre::HardwareBufferManagerBase^ mgr );
	...
	public:
		...
		Mogre::IndexData^ Clone( bool copyData, Mogre::HardwareBufferManagerBase^ mgr );
