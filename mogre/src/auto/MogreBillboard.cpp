...
namespace Mogre
{
	...
	CLRHandle Billboard::_CLRHandle::get()
	{
		return static_cast<Ogre::Billboard*>(_native)->_CLRHandle;
	}
	void Billboard::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::Billboard*>(_native)->_CLRHandle = value;
	}
