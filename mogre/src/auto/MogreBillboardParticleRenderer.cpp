...
namespace Mogre
{
	...
	void BillboardParticleRenderer::_Init_CLRObject( )
	{
		static_cast<Ogre::BillboardParticleRenderer*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BillboardParticleRenderer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BillboardParticleRenderer(pClrObj);
	}
