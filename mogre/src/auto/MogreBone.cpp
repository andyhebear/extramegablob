...
namespace Mogre
{
	...
	void Bone::_Init_CLRObject( )
	{
		static_cast<Ogre::Bone*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Bone(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Bone(pClrObj);
	}
