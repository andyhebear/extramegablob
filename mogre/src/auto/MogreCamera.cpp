...
namespace Mogre
{
	...
	{
		return static_cast<const Ogre::Camera*>(_native)->getCullingFrustum( );
	}
	...
	Mogre::Camera^ Camera::LodCamera::get()
	{
		return static_cast<const Ogre::Camera*>(_native)->getLodCamera( );
	}
	void Camera::LodCamera::set( Mogre::Camera^ lodCam )
	{
		static_cast<Ogre::Camera*>(_native)->setLodCamera( lodCam );
	}
	...
	Mogre::Quaternion Camera::OrientationForViewUpdate::get()
	{
		return static_cast<const Ogre::Camera*>(_native)->getOrientationForViewUpdate( );
	}
	...
	Mogre::Vector3 Camera::PositionForViewUpdate::get()
	{
		return static_cast<const Ogre::Camera*>(_native)->getPositionForViewUpdate( );
	}
	...
	void Camera::_Init_CLRObject( )
	{
		static_cast<Ogre::Camera*>(_native)->_Init_CLRObject( );
	}
	...
	void Camera::GetCameraToViewportRay( Mogre::Real screenx, Mogre::Real screeny, Mogre::Ray* outRay )
	{
		Ogre::Ray* o_outRay = reinterpret_cast<Ogre::Ray*>(outRay);
	
		static_cast<const Ogre::Camera*>(_native)->getCameraToViewportRay( screenx, screeny, o_outRay );
	}
	
	Mogre::PlaneBoundedVolume^ Camera::GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom, bool includeFarPlane )
	{
		return static_cast<Ogre::Camera*>(_native)->getCameraToViewportBoxVolume( screenLeft, screenTop, screenRight, screenBottom, includeFarPlane );
	}
	Mogre::PlaneBoundedVolume^ Camera::GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom )
	{
		return static_cast<Ogre::Camera*>(_native)->getCameraToViewportBoxVolume( screenLeft, screenTop, screenRight, screenBottom );
	}
	
	void Camera::GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom, Mogre::PlaneBoundedVolume^ outVolume, bool includeFarPlane )
	{
		static_cast<Ogre::Camera*>(_native)->getCameraToViewportBoxVolume( screenLeft, screenTop, screenRight, screenBottom, outVolume, includeFarPlane );
	}
	void Camera::GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom, Mogre::PlaneBoundedVolume^ outVolume )
	{
		static_cast<Ogre::Camera*>(_native)->getCameraToViewportBoxVolume( screenLeft, screenTop, screenRight, screenBottom, outVolume );
	}
	...
	void Camera::SynchroniseBaseSettingsWith( Mogre::Camera^ cam )
	{
		static_cast<Ogre::Camera*>(_native)->synchroniseBaseSettingsWith( cam );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Camera(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Camera(pClrObj);
	}
