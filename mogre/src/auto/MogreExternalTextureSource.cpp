...
namespace Mogre
{
	...
	void ExternalTextureSource::_Init_CLRObject( )
	{
		static_cast<Ogre::ExternalTextureSource*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ExternalTextureSource(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ExternalTextureSource(pClrObj);
	}
