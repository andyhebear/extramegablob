...
namespace Mogre
{
	...
	void HardwareBuffer::_Init_CLRObject( )
	{
		static_cast<Ogre::HardwareBuffer*>(_native)->_Init_CLRObject( );
	}
	...
	void HardwareBuffer::CopyData( Mogre::HardwareBuffer^ srcBuffer )
	{
		static_cast<Ogre::HardwareBuffer*>(_native)->copyData( srcBuffer );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_HardwareBuffer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::HardwareBuffer(pClrObj);
	}
