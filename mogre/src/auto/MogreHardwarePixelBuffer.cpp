...
namespace Mogre
{
	...
	void HardwarePixelBuffer::_Init_CLRObject( )
	{
		static_cast<Ogre::HardwarePixelBuffer*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_HardwarePixelBuffer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::HardwarePixelBuffer(pClrObj);
	}
