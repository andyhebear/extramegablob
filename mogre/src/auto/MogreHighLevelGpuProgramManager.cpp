...
namespace Mogre
{
	...
	bool HighLevelGpuProgramManager::IsLanguageSupported( String^ lang )
	{
		DECLARE_NATIVE_STRING( o_lang, lang )
	
		return static_cast<Ogre::HighLevelGpuProgramManager*>(_native)->isLanguageSupported( o_lang );
	}
