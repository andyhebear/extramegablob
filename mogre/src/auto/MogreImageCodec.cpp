...
namespace Mogre
{
	...
	void ImageCodec::ImageData::_Init_CLRObject( )
	{
		static_cast<Ogre::ImageCodec::ImageData*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ImageCodec_ImageData(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ImageCodec::ImageData(pClrObj);
	}
	...
	void ImageCodec::_Init_CLRObject( )
	{
		static_cast<Ogre::ImageCodec*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ImageCodec(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ImageCodec(pClrObj);
	}
