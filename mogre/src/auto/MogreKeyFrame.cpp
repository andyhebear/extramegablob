...
namespace Mogre
{
	...
	void KeyFrame::_Init_CLRObject( )
	{
		static_cast<Ogre::KeyFrame*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_KeyFrame(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::KeyFrame(pClrObj);
	}
	...
	void NumericKeyFrame::_Init_CLRObject( )
	{
		static_cast<Ogre::NumericKeyFrame*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_NumericKeyFrame(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::NumericKeyFrame(pClrObj);
	}
	...
	void TransformKeyFrame::_Init_CLRObject( )
	{
		static_cast<Ogre::TransformKeyFrame*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_TransformKeyFrame(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::TransformKeyFrame(pClrObj);
	}
	...
	void VertexMorphKeyFrame::_Init_CLRObject( )
	{
		static_cast<Ogre::VertexMorphKeyFrame*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_VertexMorphKeyFrame(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::VertexMorphKeyFrame(pClrObj);
	}
	...
	void VertexPoseKeyFrame::_Init_CLRObject( )
	{
		static_cast<Ogre::VertexPoseKeyFrame*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_VertexPoseKeyFrame(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::VertexPoseKeyFrame(pClrObj);
	}
