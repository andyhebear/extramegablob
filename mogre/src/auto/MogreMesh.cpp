...
namespace Mogre
{
	...
	CPP_DECLARE_STLVECTOR( Mesh::, LodValueList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE )
	#undef STLDECL_MANAGEDTYPE
	#undef STLDECL_NATIVETYPE
	
	#define STLDECL_MANAGEDTYPE Mogre::MeshLodUsage^
	#define STLDECL_NATIVETYPE Ogre::MeshLodUsage
	CPP_DECLARE_STLVECTOR( Mesh::, MeshLodUsageList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE )
	#undef STLDECL_MANAGEDTYPE
	#undef STLDECL_NATIVETYPE
	...
	Mogre::LodStrategy^ Mesh::LodStrategy::get()
	{
		return static_cast<const Ogre::Mesh*>(_native)->getLodStrategy( );
	}
	void Mesh::LodStrategy::set( Mogre::LodStrategy^ lodStrategy )
	{
		static_cast<Ogre::Mesh*>(_native)->setLodStrategy( lodStrategy );
	}
	...
	void Mesh::_Init_CLRObject( )
	{
		static_cast<Ogre::Mesh*>(_native)->_Init_CLRObject( );
	}
	...
	void Mesh::UnnameSubMesh( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		static_cast<Ogre::Mesh*>(_native)->unnameSubMesh( o_name );
	}
	...
	{
		static_cast<Ogre::Mesh*>(_native)->destroySubMesh( index );
	}
	
	void Mesh::DestroySubMesh( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		static_cast<Ogre::Mesh*>(_native)->destroySubMesh( o_name );
	}
	...
	Mogre::Mesh::Const_VertexBoneAssignmentList^ Mesh::GetBoneAssignments( )
	{
		return static_cast<const Ogre::Mesh*>(_native)->getBoneAssignments( );
	}
	
	void Mesh::GenerateLodLevels( Mogre::Mesh::Const_LodValueList^ lodValues, Mogre::ProgressiveMesh::VertexReductionQuota reductionMethod, Mogre::Real reductionValue )
	{
		static_cast<Ogre::Mesh*>(_native)->generateLodLevels( lodValues, (Ogre::ProgressiveMesh::VertexReductionQuota)reductionMethod, reductionValue );
	}
	...
	void Mesh::CreateManualLodLevel( Mogre::Real value, String^ meshName, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_meshName, meshName )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::Mesh*>(_native)->createManualLodLevel( value, o_meshName, o_groupName );
	}
	void Mesh::CreateManualLodLevel( Mogre::Real value, String^ meshName )
	{
		DECLARE_NATIVE_STRING( o_meshName, meshName )
	
		static_cast<Ogre::Mesh*>(_native)->createManualLodLevel( value, o_meshName );
	}
	...
	Mogre::ushort Mesh::GetLodIndex( Mogre::Real value )
	{
		return static_cast<const Ogre::Mesh*>(_native)->getLodIndex( value );
	}
	...
	void Mesh::BuildTangentVectors( Mogre::VertexElementSemantic targetSemantic, unsigned short sourceTexCoordSet, unsigned short index, bool splitMirrored, bool splitRotated, bool storeParityInW )
	{
		static_cast<Ogre::Mesh*>(_native)->buildTangentVectors( (Ogre::VertexElementSemantic)targetSemantic, sourceTexCoordSet, index, splitMirrored, splitRotated, storeParityInW );
	}
	void Mesh::BuildTangentVectors( Mogre::VertexElementSemantic targetSemantic, unsigned short sourceTexCoordSet, unsigned short index, bool splitMirrored, bool splitRotated )
	{
		static_cast<Ogre::Mesh*>(_native)->buildTangentVectors( (Ogre::VertexElementSemantic)targetSemantic, sourceTexCoordSet, index, splitMirrored, splitRotated );
	}
	void Mesh::BuildTangentVectors( Mogre::VertexElementSemantic targetSemantic, unsigned short sourceTexCoordSet, unsigned short index, bool splitMirrored )
	{
		static_cast<Ogre::Mesh*>(_native)->buildTangentVectors( (Ogre::VertexElementSemantic)targetSemantic, sourceTexCoordSet, index, splitMirrored );
	}
	...
	Mogre::EdgeData^ Mesh::GetEdgeList( unsigned short lodIndex )
	{
	...
	__declspec(dllexport) void _Init_CLRObject_Mesh(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Mesh(pClrObj);
	}
	...
	Mogre::Real MeshLodUsage::userValue::get()
	{
		return static_cast<Ogre::MeshLodUsage*>(_native)->userValue;
	}
	void MeshLodUsage::userValue::set( Mogre::Real value )
	{
		static_cast<Ogre::MeshLodUsage*>(_native)->userValue = value;
	}
	
	Mogre::Real MeshLodUsage::value::get()
	{
		return static_cast<Ogre::MeshLodUsage*>(_native)->value;
	}
	void MeshLodUsage::value::set( Mogre::Real value )
	{
		static_cast<Ogre::MeshLodUsage*>(_native)->value = value;
	}
	...
	String^ MeshLodUsage::manualGroup::get()
	{
		return TO_CLR_STRING( static_cast<Ogre::MeshLodUsage*>(_native)->manualGroup );
	}
	void MeshLodUsage::manualGroup::set( String^ value )
	{
		DECLARE_NATIVE_STRING( o_value, value )
	
		static_cast<Ogre::MeshLodUsage*>(_native)->manualGroup = o_value;
	}
