...
namespace Mogre
{
	...
	bool MovableObject::IsDebugDisplayEnabled::get()
	{
		return static_cast<const Ogre::MovableObject*>(_native)->isDebugDisplayEnabled( );
	}
	...
	bool MovableObject::IsParentTagPoint::get()
	{
		return static_cast<const Ogre::MovableObject*>(_native)->isParentTagPoint( );
	}
	...
	Mogre::uint32 MovableObject::LightMask::get()
	{
		return static_cast<const Ogre::MovableObject*>(_native)->getLightMask( );
	}
	void MovableObject::LightMask::set( Mogre::uint32 lightMask )
	{
		static_cast<Ogre::MovableObject*>(_native)->setLightMask( lightMask );
	}
	...
	bool MovableObject::ReceivesShadows::get()
	{
		return static_cast<Ogre::MovableObject*>(_native)->getReceivesShadows( );
	}
	...
	Mogre::UserObjectBindings^ MovableObject::UserObjectBindings::get()
	{
		return static_cast<Ogre::MovableObject*>(_native)->getUserObjectBindings( );
	}
	...
	void MovableObject::_Init_CLRObject( )
	{
		static_cast<Ogre::MovableObject*>(_native)->_Init_CLRObject( );
	}
	...
	{
		static_cast<Ogre::MovableObject*>(_native)->detachFromParent( );
	}
	...
	void MovableObject::SetRenderQueueGroupAndPriority( Mogre::uint8 queueID, Mogre::ushort priority )
	{
		static_cast<Ogre::MovableObject*>(_native)->setRenderQueueGroupAndPriority( queueID, priority );
	}
	...
	Mogre::LightList^ MovableObject::_getLightList( )
	{
		return static_cast<Ogre::MovableObject*>(_native)->_getLightList( );
	}
	...
	{
		static_cast<Ogre::MovableObject*>(_native)->setDebugDisplayEnabled( enabled );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_MovableObject(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::MovableObject(pClrObj);
	}
	...
	void MovableObjectFactory::_Init_CLRObject( )
	{
		static_cast<Ogre::MovableObjectFactory*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_MovableObjectFactory(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::MovableObjectFactory(pClrObj);
	}
