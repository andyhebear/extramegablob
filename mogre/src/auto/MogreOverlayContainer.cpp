...
namespace Mogre
{
	...
	void OverlayContainer::_Init_CLRObject( )
	{
		static_cast<Ogre::OverlayContainer*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::ushort OverlayContainer::_notifyZOrder( Mogre::ushort newZOrder )
	{
		return static_cast<Ogre::OverlayContainer*>(_native)->_notifyZOrder( newZOrder );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_OverlayContainer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::OverlayContainer(pClrObj);
	}
