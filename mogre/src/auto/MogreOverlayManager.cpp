...
namespace Mogre
{
	...
	CPP_DECLARE_STLMAP( OverlayManager::, FactoryMap, STLDECL_MANAGEDKEY, STLDECL_MANAGEDVALUE, STLDECL_NATIVEKEY, STLDECL_NATIVEVALUE )
	#undef STLDECL_MANAGEDKEY
	#undef STLDECL_MANAGEDVALUE
	#undef STLDECL_NATIVEKEY
	#undef STLDECL_NATIVEVALUE
	...
	Mogre::OrientationMode OverlayManager::ViewportOrientationMode::get()
	{
		return (Mogre::OrientationMode)static_cast<const Ogre::OverlayManager*>(_native)->getViewportOrientationMode( );
	}
	...
	bool OverlayManager::HasOverlayElement( String^ name, bool isTemplate )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		return static_cast<Ogre::OverlayManager*>(_native)->hasOverlayElement( o_name, isTemplate );
	}
	bool OverlayManager::HasOverlayElement( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		return static_cast<Ogre::OverlayManager*>(_native)->hasOverlayElement( o_name );
	}
	...
	Mogre::OverlayManager::Const_FactoryMap^ OverlayManager::GetOverlayElementFactoryMap( )
	{
		return static_cast<const Ogre::OverlayManager*>(_native)->getOverlayElementFactoryMap( );
	}
