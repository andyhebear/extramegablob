...
namespace Mogre
{
	...
	void PanelOverlayElement::_Init_CLRObject( )
	{
		static_cast<Ogre::PanelOverlayElement*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_PanelOverlayElement(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::PanelOverlayElement(pClrObj);
	}
