...
namespace Mogre
{
	...
	CLRHandle Particle::_CLRHandle::get()
	{
		return static_cast<Ogre::Particle*>(_native)->_CLRHandle;
	}
	void Particle::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::Particle*>(_native)->_CLRHandle = value;
	}
