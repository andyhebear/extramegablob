...
namespace Mogre
{
	...
	void ParticleAffector::_Init_CLRObject( )
	{
		static_cast<Ogre::ParticleAffector*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ParticleAffector(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ParticleAffector(pClrObj);
	}
