...
namespace Mogre
{
	...
	void ParticleEmitter::_Init_CLRObject( )
	{
		static_cast<Ogre::ParticleEmitter*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ParticleEmitter(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ParticleEmitter(pClrObj);
	}
