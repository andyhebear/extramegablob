...
namespace Mogre
{
	...
	CLRHandle Pass::_CLRHandle::get()
	{
		return static_cast<Ogre::Pass*>(_native)->_CLRHandle;
	}
	void Pass::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::Pass*>(_native)->_CLRHandle = value;
	}
	...
	Mogre::SceneBlendFactor Pass::DestBlendFactorAlpha::get()
	{
		return (Mogre::SceneBlendFactor)static_cast<const Ogre::Pass*>(_native)->getDestBlendFactorAlpha( );
	}
	...
	String^ Pass::GeometryProgramName::get()
	{
		return TO_CLR_STRING( static_cast<const Ogre::Pass*>(_native)->getGeometryProgramName( ) );
	}
	...
	bool Pass::HasGeometryProgram::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->hasGeometryProgram( );
	}
	...
	bool Pass::HasSeparateSceneBlending::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->hasSeparateSceneBlending( );
	}
	
	bool Pass::HasSeparateSceneBlendingOperations::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->hasSeparateSceneBlendingOperations( );
	}
	...
	Mogre::IlluminationStage Pass::IlluminationStage::get()
	{
		return (Mogre::IlluminationStage)static_cast<const Ogre::Pass*>(_native)->getIlluminationStage( );
	}
	void Pass::IlluminationStage::set( Mogre::IlluminationStage is )
	{
		static_cast<Ogre::Pass*>(_native)->setIlluminationStage( (Ogre::IlluminationStage)is );
	}
	...
	bool Pass::IsAlphaToCoverageEnabled::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->isAlphaToCoverageEnabled( );
	}
	...
	float Pass::IterationDepthBias::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getIterationDepthBias( );
	}
	void Pass::IterationDepthBias::set( float biasPerIteration )
	{
		static_cast<Ogre::Pass*>(_native)->setIterationDepthBias( biasPerIteration );
	}
	
	bool Pass::LightClipPlanesEnabled::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getLightClipPlanesEnabled( );
	}
	void Pass::LightClipPlanesEnabled::set( bool enabled )
	{
		static_cast<Ogre::Pass*>(_native)->setLightClipPlanesEnabled( enabled );
	}
	...
	bool Pass::LightScissoringEnabled::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getLightScissoringEnabled( );
	}
	void Pass::LightScissoringEnabled::set( bool enabled )
	{
		static_cast<Ogre::Pass*>(_native)->setLightScissoringEnabled( enabled );
	}
	...
	bool Pass::NormaliseNormals::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getNormaliseNormals( );
	}
	void Pass::NormaliseNormals::set( bool normalise )
	{
		static_cast<Ogre::Pass*>(_native)->setNormaliseNormals( normalise );
	}
	...
	bool Pass::PolygonModeOverrideable::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getPolygonModeOverrideable( );
	}
	void Pass::PolygonModeOverrideable::set( bool override )
	{
		static_cast<Ogre::Pass*>(_native)->setPolygonModeOverrideable( override );
	}
	...
	Mogre::SceneBlendOperation Pass::SceneBlendingOperation::get()
	{
		return (Mogre::SceneBlendOperation)static_cast<const Ogre::Pass*>(_native)->getSceneBlendingOperation( );
	}
	void Pass::SceneBlendingOperation::set( Mogre::SceneBlendOperation op )
	{
		static_cast<Ogre::Pass*>(_native)->setSceneBlendingOperation( (Ogre::SceneBlendOperation)op );
	}
	
	Mogre::SceneBlendOperation Pass::SceneBlendingOperationAlpha::get()
	{
		return (Mogre::SceneBlendOperation)static_cast<const Ogre::Pass*>(_native)->getSceneBlendingOperationAlpha( );
	}
	...
	Mogre::SceneBlendFactor Pass::SourceBlendFactorAlpha::get()
	{
		return (Mogre::SceneBlendFactor)static_cast<const Ogre::Pass*>(_native)->getSourceBlendFactorAlpha( );
	}
	...
	bool Pass::TransparentSortingEnabled::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getTransparentSortingEnabled( );
	}
	void Pass::TransparentSortingEnabled::set( bool enabled )
	{
		static_cast<Ogre::Pass*>(_native)->setTransparentSortingEnabled( enabled );
	}
	
	bool Pass::TransparentSortingForced::get()
	{
		return static_cast<const Ogre::Pass*>(_native)->getTransparentSortingForced( );
	}
	void Pass::TransparentSortingForced::set( bool enabled )
	{
		static_cast<Ogre::Pass*>(_native)->setTransparentSortingForced( enabled );
	}
	
	Mogre::UserObjectBindings^ Pass::UserObjectBindings::get()
	{
		return static_cast<Ogre::Pass*>(_native)->getUserObjectBindings( );
	}
	...
	void Pass::SetSeparateSceneBlending( Mogre::SceneBlendType sbt, Mogre::SceneBlendType sbta )
	{
		static_cast<Ogre::Pass*>(_native)->setSeparateSceneBlending( (Ogre::SceneBlendType)sbt, (Ogre::SceneBlendType)sbta );
	}
	...
	void Pass::SetSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha )
	{
		static_cast<Ogre::Pass*>(_native)->setSeparateSceneBlending( (Ogre::SceneBlendFactor)sourceFactor, (Ogre::SceneBlendFactor)destFactor, (Ogre::SceneBlendFactor)sourceFactorAlpha, (Ogre::SceneBlendFactor)destFactorAlpha );
	}
	
	void Pass::SetSeparateSceneBlendingOperation( Mogre::SceneBlendOperation op, Mogre::SceneBlendOperation alphaOp )
	{
		static_cast<Ogre::Pass*>(_native)->setSeparateSceneBlendingOperation( (Ogre::SceneBlendOperation)op, (Ogre::SceneBlendOperation)alphaOp );
	}
	...
	void Pass::SetAlphaRejectSettings( Mogre::CompareFunction func, unsigned char value, bool alphaToCoverageEnabled )
	{
		static_cast<Ogre::Pass*>(_native)->setAlphaRejectSettings( (Ogre::CompareFunction)func, value, alphaToCoverageEnabled );
	}
	...
	{
		static_cast<Ogre::Pass*>(_native)->setAlphaToCoverageEnabled( enabled );
	}
	...
	void Pass::SetGeometryProgram( String^ name, bool resetParams )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		static_cast<Ogre::Pass*>(_native)->setGeometryProgram( o_name, resetParams );
	}
	void Pass::SetGeometryProgram( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		static_cast<Ogre::Pass*>(_native)->setGeometryProgram( o_name );
	}
	
	void Pass::SetGeometryProgramParameters( Mogre::GpuProgramParametersSharedPtr^ params )
	{
		static_cast<Ogre::Pass*>(_native)->setGeometryProgramParameters( (Ogre::GpuProgramParametersSharedPtr)params );
	}
	
	Mogre::GpuProgramParametersSharedPtr^ Pass::GetGeometryProgramParameters( )
	{
		return static_cast<const Ogre::Pass*>(_native)->getGeometryProgramParameters( );
	}
	
	Mogre::GpuProgramPtr^ Pass::GetGeometryProgram( )
	{
		return static_cast<const Ogre::Pass*>(_native)->getGeometryProgram( );
	}
	...
	void Pass::_prepare( )
	{
		static_cast<Ogre::Pass*>(_native)->_prepare( );
	}
	
	void Pass::_unprepare( )
	{
		static_cast<Ogre::Pass*>(_native)->_unprepare( );
	}
