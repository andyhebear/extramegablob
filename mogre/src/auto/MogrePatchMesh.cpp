...
namespace Mogre
{
	...
	void PatchMesh::_Init_CLRObject( )
	{
		static_cast<Ogre::PatchMesh*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_PatchMesh(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::PatchMesh(pClrObj);
	}
