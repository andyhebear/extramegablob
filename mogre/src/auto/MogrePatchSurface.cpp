...
namespace Mogre
{
	...
	CLRHandle PatchSurface::_CLRHandle::get()
	{
		return static_cast<Ogre::PatchSurface*>(_native)->_CLRHandle;
	}
	void PatchSurface::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::PatchSurface*>(_native)->_CLRHandle = value;
	}
