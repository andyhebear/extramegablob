...
namespace Mogre
{
	...
	void ProgressiveMesh::_Init_CLRObject( )
	{
		static_cast<Ogre::ProgressiveMesh*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ProgressiveMesh(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ProgressiveMesh(pClrObj);
	}
