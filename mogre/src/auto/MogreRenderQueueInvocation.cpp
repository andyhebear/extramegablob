...
namespace Mogre
{
	...
	void RenderQueueInvocation::_Init_CLRObject( )
	{
		static_cast<Ogre::RenderQueueInvocation*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RenderQueueInvocation(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RenderQueueInvocation(pClrObj);
	}
	...
	void RenderQueueInvocationSequence::_Init_CLRObject( )
	{
		static_cast<Ogre::RenderQueueInvocationSequence*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RenderQueueInvocationSequence(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RenderQueueInvocationSequence(pClrObj);
	}
