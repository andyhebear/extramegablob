...
namespace Mogre
{
	...
	#define STLDECL_MANAGEDKEY String^
	#define STLDECL_MANAGEDVALUE Mogre::ResourceManager::ResourceMap^
	#define STLDECL_NATIVEKEY Ogre::String
	#define STLDECL_NATIVEVALUE Ogre::ResourceManager::ResourceMap
	CPP_DECLARE_STLHASHMAP( ResourceManager::, ResourceWithGroupMap, STLDECL_MANAGEDKEY, STLDECL_MANAGEDVALUE, STLDECL_NATIVEKEY, STLDECL_NATIVEVALUE )
	#undef STLDECL_MANAGEDKEY
	#undef STLDECL_MANAGEDVALUE
	#undef STLDECL_NATIVEKEY
	#undef STLDECL_NATIVEVALUE
	...
	bool ResourceManager::Verbose::get()
	{
		return static_cast<Ogre::ResourceManager*>(_native)->getVerbose( );
	}
	void ResourceManager::Verbose::set( bool v )
	{
		static_cast<Ogre::ResourceManager*>(_native)->setVerbose( v );
	}
	...
	{
		static_cast<Ogre::ResourceManager*>(_native)->removeUnreferencedResources( reloadableOnly );
	}
	void ResourceManager::RemoveUnreferencedResources( )
	{
		static_cast<Ogre::ResourceManager*>(_native)->removeUnreferencedResources( );
	}
	
	Mogre::ResourcePtr^ ResourceManager::GetByName( String^ name, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::ResourceManager*>(_native)->getByName( o_name, o_groupName );
	}
	...
	Mogre::ResourcePtr^ ResourceManager::Prepare( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ loadParams, bool backgroundThread )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return static_cast<Ogre::ResourceManager*>(_native)->prepare( o_name, o_group, isManual, loader, loadParams, backgroundThread );
	}
	Mogre::ResourcePtr^ ResourceManager::Prepare( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ loadParams )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return static_cast<Ogre::ResourceManager*>(_native)->prepare( o_name, o_group, isManual, loader, loadParams );
	}
	Mogre::ResourcePtr^ ResourceManager::Prepare( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return static_cast<Ogre::ResourceManager*>(_native)->prepare( o_name, o_group, isManual, loader );
	}
	Mogre::ResourcePtr^ ResourceManager::Prepare( String^ name, String^ group, bool isManual )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return static_cast<Ogre::ResourceManager*>(_native)->prepare( o_name, o_group, isManual );
	}
	Mogre::ResourcePtr^ ResourceManager::Prepare( String^ name, String^ group )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return static_cast<Ogre::ResourceManager*>(_native)->prepare( o_name, o_group );
	}
	
	Mogre::ResourcePtr^ ResourceManager::Load( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ loadParams, bool backgroundThread )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return static_cast<Ogre::ResourceManager*>(_native)->load( o_name, o_group, isManual, loader, loadParams, backgroundThread );
	}
	...
	{
		static_cast<Ogre::ResourceManager*>(_native)->destroyAllResourcePools( );
	}
