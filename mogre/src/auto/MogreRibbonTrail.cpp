...
namespace Mogre
{
	...
	void RibbonTrail::_Init_CLRObject( )
	{
		static_cast<Ogre::RibbonTrail*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RibbonTrail(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RibbonTrail(pClrObj);
	}
	...
	void RibbonTrailFactory::_Init_CLRObject( )
	{
		static_cast<Ogre::RibbonTrailFactory*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RibbonTrailFactory(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RibbonTrailFactory(pClrObj);
	}
