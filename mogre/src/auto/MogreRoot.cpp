...
namespace Mogre
{
	...
	{
		return static_cast<const Ogre::Root*>(_native)->getDisplayMonitorCount( );
	}
	...
	unsigned long Root::NextFrameNumber::get()
	{
		return static_cast<const Ogre::Root*>(_native)->getNextFrameNumber( );
	}
	
	bool Root::RemoveRenderQueueStructuresOnClear::get()
	{
		return static_cast<const Ogre::Root*>(_native)->getRemoveRenderQueueStructuresOnClear( );
	}
	void Root::RemoveRenderQueueStructuresOnClear::set( bool r )
	{
		static_cast<Ogre::Root*>(_native)->setRemoveRenderQueueStructuresOnClear( r );
	}
	...
	Mogre::RenderWindow^ Root::Initialise( bool autoCreateWindow, String^ windowTitle, String^ customCapabilitiesConfig )
	{
		DECLARE_NATIVE_STRING( o_windowTitle, windowTitle )
		DECLARE_NATIVE_STRING( o_customCapabilitiesConfig, customCapabilitiesConfig )
	
		return static_cast<Ogre::Root*>(_native)->initialise( autoCreateWindow, o_windowTitle, o_customCapabilitiesConfig );
	}
	...
	void Root::UseCustomRenderSystemCapabilities( Mogre::RenderSystemCapabilities^ capabilities )
	{
		static_cast<Ogre::Root*>(_native)->useCustomRenderSystemCapabilities( capabilities );
	}
	...
	bool Root::HasSceneManager( String^ instanceName )
	{
		DECLARE_NATIVE_STRING( o_instanceName, instanceName )
	
		return static_cast<const Ogre::Root*>(_native)->hasSceneManager( o_instanceName );
	}
	...
	bool Root::RenderOneFrame( Mogre::Real timeSinceLastFrame )
	{
		return static_cast<Ogre::Root*>(_native)->renderOneFrame( timeSinceLastFrame );
	}
	...
	Mogre::DataStreamPtr^ Root::CreateFileStream( String^ filename, String^ groupName, bool overwrite, String^ locationPattern )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
		DECLARE_NATIVE_STRING( o_locationPattern, locationPattern )
	
		return static_cast<Ogre::Root*>(_native)->createFileStream( o_filename, o_groupName, overwrite, o_locationPattern );
	}
	Mogre::DataStreamPtr^ Root::CreateFileStream( String^ filename, String^ groupName, bool overwrite )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::Root*>(_native)->createFileStream( o_filename, o_groupName, overwrite );
	}
	Mogre::DataStreamPtr^ Root::CreateFileStream( String^ filename, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::Root*>(_native)->createFileStream( o_filename, o_groupName );
	}
	Mogre::DataStreamPtr^ Root::CreateFileStream( String^ filename )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
	
		return static_cast<Ogre::Root*>(_native)->createFileStream( o_filename );
	}
	
	Mogre::DataStreamPtr^ Root::OpenFileStream( String^ filename, String^ groupName, String^ locationPattern )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
		DECLARE_NATIVE_STRING( o_locationPattern, locationPattern )
	
		return static_cast<Ogre::Root*>(_native)->openFileStream( o_filename, o_groupName, o_locationPattern );
	}
	Mogre::DataStreamPtr^ Root::OpenFileStream( String^ filename, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::Root*>(_native)->openFileStream( o_filename, o_groupName );
	}
	Mogre::DataStreamPtr^ Root::OpenFileStream( String^ filename )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
	
		return static_cast<Ogre::Root*>(_native)->openFileStream( o_filename );
	}
	...
	bool Root::_fireFrameRenderingQueued( Mogre::FrameEvent evt )
	{
		return static_cast<Ogre::Root*>(_native)->_fireFrameRenderingQueued( evt );
	}
	...
	{
		return static_cast<Ogre::Root*>(_native)->_fireFrameRenderingQueued( );
	}
	...
	void Root::_pushCurrentSceneManager( Mogre::SceneManager^ sm )
	{
		static_cast<Ogre::Root*>(_native)->_pushCurrentSceneManager( sm );
	}
	
	void Root::_popCurrentSceneManager( Mogre::SceneManager^ sm )
	{
		static_cast<Ogre::Root*>(_native)->_popCurrentSceneManager( sm );
	}
	
	bool Root::_updateAllRenderTargets( )
	{
		return static_cast<Ogre::Root*>(_native)->_updateAllRenderTargets( );
	}
	
	bool Root::_updateAllRenderTargets( Mogre::FrameEvent evt )
	{
		return static_cast<Ogre::Root*>(_native)->_updateAllRenderTargets( evt );
	}
