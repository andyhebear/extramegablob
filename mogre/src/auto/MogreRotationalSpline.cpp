...
namespace Mogre
{
	...
	CLRHandle RotationalSpline::_CLRHandle::get()
	{
		return static_cast<Ogre::RotationalSpline*>(_native)->_CLRHandle;
	}
	void RotationalSpline::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::RotationalSpline*>(_native)->_CLRHandle = value;
	}
