...
namespace Mogre
{
	...
	void ShadowRenderable::_Init_CLRObject( )
	{
		static_cast<Ogre::ShadowRenderable*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::UserObjectBindings^ ShadowRenderable::UserObjectBindings::get()
	{
		return static_cast<Ogre::ShadowRenderable*>(_native)->getUserObjectBindings( );
	}
	
	bool ShadowRenderable::PreRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		return static_cast<Ogre::ShadowRenderable*>(_native)->preRender( sm, rsys );
	}
	
	void ShadowRenderable::PostRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		static_cast<Ogre::ShadowRenderable*>(_native)->postRender( sm, rsys );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ShadowRenderable(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ShadowRenderable(pClrObj);
	}
	...
	void ShadowCaster::_Init_CLRObject( )
	{
		static_cast<Ogre::ShadowCaster*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ShadowCaster(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ShadowCaster(pClrObj);
	}
