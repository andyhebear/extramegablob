...
namespace Mogre
{
	...
	void SkeletonInstance::_Init_CLRObject( )
	{
		static_cast<Ogre::SkeletonInstance*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_SkeletonInstance(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::SkeletonInstance(pClrObj);
	}
