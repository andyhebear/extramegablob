...
namespace Mogre
{
	...
	bool UnifiedHighLevelGpuProgram::IsLoading::get()
	{
		return static_cast<const Ogre::UnifiedHighLevelGpuProgram*>(_native)->isLoading( );
	}
	...
	bool UnifiedHighLevelGpuProgram::PassFogStates::get()
	{
		return static_cast<const Ogre::UnifiedHighLevelGpuProgram*>(_native)->getPassFogStates( );
	}
	...
	bool UnifiedHighLevelGpuProgram::PassTransformStates::get()
	{
		return static_cast<const Ogre::UnifiedHighLevelGpuProgram*>(_native)->getPassTransformStates( );
	}
	...
	void UnifiedHighLevelGpuProgram::_Init_CLRObject( )
	{
		static_cast<Ogre::UnifiedHighLevelGpuProgram*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::Resource::LoadingState UnifiedHighLevelGpuProgram::GetLoadingState( )
	{
	...
	__declspec(dllexport) void _Init_CLRObject_UnifiedHighLevelGpuProgram(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::UnifiedHighLevelGpuProgram(pClrObj);
	}
