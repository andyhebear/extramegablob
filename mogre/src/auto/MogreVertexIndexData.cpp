...
namespace Mogre
{
	...
	VertexData::VertexData( Mogre::VertexDeclaration^ dcl, Mogre::VertexBufferBinding^ bind )
	{
		_createdByCLR = true;
		_native = new Ogre::VertexData( dcl, bind);
	
		_native->_CLRHandle._MapToCLRObject(this, System::Runtime::InteropServices::GCHandleType::Normal);
	}
	
	CLRHandle VertexData::_CLRHandle::get()
	{
		return static_cast<Ogre::VertexData*>(_native)->_CLRHandle;
	}
	void VertexData::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::VertexData*>(_native)->_CLRHandle = value;
	}
	...
	bool VertexData::mDeleteDclBinding::get()
	{
		return static_cast<Ogre::VertexData*>(_native)->mDeleteDclBinding;
	}
	void VertexData::mDeleteDclBinding::set( bool value )
	{
		static_cast<Ogre::VertexData*>(_native)->mDeleteDclBinding = value;
	}
	...
	Mogre::VertexData^ VertexData::Clone( bool copyData, Mogre::HardwareBufferManagerBase^ mgr )
	{
		return static_cast<const Ogre::VertexData*>(_native)->clone( copyData, mgr );
	}
	...
	void VertexData::ReorganiseBuffers( Mogre::VertexDeclaration^ newDeclaration, Mogre::Const_BufferUsageList^ bufferUsage, Mogre::HardwareBufferManagerBase^ mgr )
	{
		static_cast<Ogre::VertexData*>(_native)->reorganiseBuffers( newDeclaration, bufferUsage, mgr );
	}
	...
	void VertexData::ReorganiseBuffers( Mogre::VertexDeclaration^ newDeclaration, Mogre::HardwareBufferManagerBase^ mgr )
	{
		static_cast<Ogre::VertexData*>(_native)->reorganiseBuffers( newDeclaration, mgr );
	}
	...
	CLRHandle IndexData::_CLRHandle::get()
	{
		return static_cast<Ogre::IndexData*>(_native)->_CLRHandle;
	}
	void IndexData::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::IndexData*>(_native)->_CLRHandle = value;
	}
	...
	Mogre::IndexData^ IndexData::Clone( bool copyData, Mogre::HardwareBufferManagerBase^ mgr )
	{
		return static_cast<const Ogre::IndexData*>(_native)->clone( copyData, mgr );
	}
