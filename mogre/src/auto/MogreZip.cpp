...
namespace Mogre
{
	...
	void ZipArchive::_Init_CLRObject( )
	{
		static_cast<Ogre::ZipArchive*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::DataStreamPtr^ ZipArchive::Open( String^ filename, bool readOnly )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
	
		return static_cast<const Ogre::ZipArchive*>(_native)->open( o_filename, readOnly );
	}
	...
	Mogre::DataStreamPtr^ ZipArchive::Create( String^ filename )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
	
		return static_cast<const Ogre::ZipArchive*>(_native)->create( o_filename );
	}
	
	void ZipArchive::Remove( String^ filename )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
	
		static_cast<const Ogre::ZipArchive*>(_native)->remove( o_filename );
	}
	...
	time_t ZipArchive::GetModifiedTime( String^ filename )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
	
		return static_cast<Ogre::ZipArchive*>(_native)->getModifiedTime( o_filename );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ZipArchive(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ZipArchive(pClrObj);
	}
