...
EXPORT void CloudsManager_Remove(SkyX::CloudsManager* ptr,SkyX::CloudLayer* layer)
{
	return ptr->remove(layer);
}

EXPORT void CloudsManager_RemoveAll(SkyX::CloudsManager* ptr)
{
	return ptr->removeAll();
}

EXPORT void CloudsManager_RegisterAll(SkyX::CloudsManager* ptr)
{
	return ptr->registerAll();
}

EXPORT void CloudsManager_UnregisterAll(SkyX::CloudsManager* ptr)
{
	return ptr->unregisterAll();
}

EXPORT void CloudsManager_Unregister(SkyX::CloudsManager* ptr,SkyX::CloudLayer* layer)
{
	return ptr->unregister(layer);
}
