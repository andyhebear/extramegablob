...
//PINVOKE WRAPPER
EXPORT void GPUManager_AddGroundPass(SkyX::GPUManager* ptr,Ogre::Pass* pass,float atmosphereRadius, Ogre::SceneBlendType blendType)
{
	ptr->addGroundPass(pass,atmosphereRadius,blendType);
}
