...
//PINVOKE WRAPPER
EXPORT  Ogre::BillboardSet* MoonManager_GetMoonBillboard(SkyX::MoonManager* ptr)
{
	return ptr->getMoonBillboard();
}


EXPORT  Ogre::SceneNode* MoonManager_GetMoonSceneNode(SkyX::MoonManager* ptr)
{
	return ptr->getMoonSceneNode();
}

EXPORT void MoonManager_SetMoonSize(SkyX::MoonManager* ptr,float value)
{
	ptr->setMoonSize(value);
}

EXPORT float MoonManager_GetMoonSize(SkyX::MoonManager* ptr)
{
	return ptr->getMoonSize();
}
