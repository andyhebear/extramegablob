...
EXPORT void VCloudsManager_Create(SkyX::VCloudsManager* ptr)
{
	ptr->create();
}

EXPORT void VCloudsManager_Update(SkyX::VCloudsManager* ptr,float time)
{
	ptr->update(time);
}

EXPORT void VCloudsManager_Remove(SkyX::VCloudsManager* ptr)
{
	ptr->remove();
}

EXPORT void VCloudsManager_SetHeight(SkyX::VCloudsManager* ptr,const Ogre::Vector2& value)
{
	ptr->setHeight(value);
}

EXPORT const Ogre::Vector2& VCloudsManager_GetHeight(SkyX::VCloudsManager* ptr)
{
	return ptr->getHeight();
}

EXPORT void VCloudsManager_SetAutoupdate(SkyX::VCloudsManager* ptr,float value)
{
	ptr->setAutoupdate(value);
}

EXPORT bool VCloudsManager_GetAutoupdate(SkyX::VCloudsManager* ptr)
{
	return ptr->getAutoupdate();
}

EXPORT void VCloudsManager_SetWindSpeed(SkyX::VCloudsManager* ptr,float value)
{
	ptr->setWindSpeed(value);
}

EXPORT float VCloudsManager_GetWindSpeed(SkyX::VCloudsManager* ptr)
{
	return ptr->getWindSpeed();
}
