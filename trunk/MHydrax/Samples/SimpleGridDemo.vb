...
Public Class SimpleGridDemo
    ...
    Private Const AppTitle As String = "MHydrax SimpleGridDemo"
    ...
    ' Pointers to MHydrax class instances:
    ...
    Public Sub CreateScene()
        ...
        camera.Position = New Vector3(312.902, 206.419, 1524.02)
        ...
        Dim m As New MHydrax.MSimpleGrid(hydrax, _
                                    New MHydrax.MPerlin, _
        ...
        ' but due to the high number of customizable parameters, Hydrax 0.4 or higher allows save/load config files.
    ...
    ''' <remarks></remarks>
    Public Sub Run()
        AddHandler root.FrameStarted, AddressOf FrameStarted
        ...
        RemoveHandler root.FrameStarted, AddressOf FrameStarted
