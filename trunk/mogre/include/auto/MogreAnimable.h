...
namespace Mogre
{
	...
	public ref class AnimableValue : public Wrapper
	{
		...
		public: enum class ValueType
		{
			...
			RADIAN = Ogre::AnimableValue::RADIAN,
			DEGREE = Ogre::AnimableValue::DEGREE
		};
	...
	public:
		...
		void SetValue( Mogre::Radian param1 );
	
		void SetValue( Mogre::Degree param1 );
		...
		void ApplyDeltaValue( Mogre::Degree param1 );
	
		void ApplyDeltaValue( Mogre::Radian param1 );
