...
namespace Mogre
{
	...
	public:
		...
		property Mogre::Camera^ LodCamera
		{
		public:
			Mogre::Camera^ get();
		public:
			void set(Mogre::Camera^ lodCam);
		}
		...
		void GetCameraToViewportRay( Mogre::Real screenx, Mogre::Real screeny, Mogre::Ray* outRay );
	
		Mogre::PlaneBoundedVolume^ GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom, bool includeFarPlane );
		Mogre::PlaneBoundedVolume^ GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom );
	
		void GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom, Mogre::PlaneBoundedVolume^ outVolume, bool includeFarPlane );
		void GetCameraToViewportBoxVolume( Mogre::Real screenLeft, Mogre::Real screenTop, Mogre::Real screenRight, Mogre::Real screenBottom, Mogre::PlaneBoundedVolume^ outVolume );
		...
		void SynchroniseBaseSettingsWith( Mogre::Camera^ cam );
