...
namespace Mogre
{
	...
	public:
		...
		Mogre::Image^ Load( Mogre::DataStreamPtr^ stream );
	
		Mogre::Image^ LoadTwoImagesAsRGBA( String^ rgbFilename, String^ alphaFilename, String^ groupName, Mogre::PixelFormat format );
		Mogre::Image^ LoadTwoImagesAsRGBA( String^ rgbFilename, String^ alphaFilename, String^ groupName );
	
		Mogre::Image^ LoadTwoImagesAsRGBA( Mogre::DataStreamPtr^ rgbStream, Mogre::DataStreamPtr^ alphaStream, Mogre::PixelFormat PF_BYTE_RGBA, String^ rgbType, String^ alphaType );
		Mogre::Image^ LoadTwoImagesAsRGBA( Mogre::DataStreamPtr^ rgbStream, Mogre::DataStreamPtr^ alphaStream, Mogre::PixelFormat PF_BYTE_RGBA, String^ rgbType );
		Mogre::Image^ LoadTwoImagesAsRGBA( Mogre::DataStreamPtr^ rgbStream, Mogre::DataStreamPtr^ alphaStream, Mogre::PixelFormat PF_BYTE_RGBA );
	
		Mogre::Image^ CombineTwoImagesAsRGBA( Mogre::Image^ rgb, Mogre::Image^ alpha, Mogre::PixelFormat format );
		Mogre::Image^ CombineTwoImagesAsRGBA( Mogre::Image^ rgb, Mogre::Image^ alpha );
	
		void Save( String^ filename );
	
		Mogre::DataStreamPtr^ Encode( String^ formatextension );
		...
		static String^ GetFileExtFromMagic( Mogre::DataStreamPtr^ stream );
