...
namespace Mogre
{
	...
	public ref class InstancedGeometry : public Wrapper
	{
		...
		public: ref class BatchInstance : public MovableObject
		{
			...
			public: INC_DECLARE_MAP_ITERATOR( InstancedObjectIterator, Ogre::InstancedGeometry::BatchInstance::InstancedObjectIterator, Mogre::InstancedGeometry::BatchInstance::ObjectsMap, Mogre::InstancedGeometry::InstancedObject^, Ogre::InstancedGeometry::InstancedObject*, unsigned short, unsigned short )
		...
		public:
			...
			property Mogre::Camera^ mCamera
			{
			public:
				Mogre::Camera^ get();
			public:
				void set(Mogre::Camera^ value);
			}
	
			property Mogre::Real mSquaredViewDepth
			{
			public:
				Mogre::Real get();
			public:
			...
			void AddInstancedObject( unsigned short index, Mogre::InstancedGeometry::InstancedObject^ object );
	
			Mogre::InstancedGeometry::InstancedObject^ IsInstancedObjectPresent( unsigned short index );
	
			Mogre::InstancedGeometry::BatchInstance::InstancedObjectIterator^ GetObjectIterator( );
		...
		public:
			...
			InstancedObject( unsigned short index, Mogre::SkeletonInstance^ skeleton, Mogre::AnimationStateSet^ animations );
			...
			void SetPositionAndOrientation( Mogre::Vector3 p, Mogre::Quaternion q );
	...
	public:
		...
		property bool ProvideWorldInverses
		{
		public:
			bool get();
		public:
