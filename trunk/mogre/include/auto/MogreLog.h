...
namespace Mogre
{
	...
	public ref class Log : public INativePointer, public ILogListener_Receiver
	{
		...
		public: ref class Stream : public INativePointer
		{
			//Nested Types
		...
		private protected:
			...
			//Internal Declarations
		public protected:
			Stream( Ogre::Log::Stream* obj ) : _native(obj), _createdByCLR(false)
			{
			}
			...
			Ogre::Log::Stream* _native;
			bool _createdByCLR;
	
	
			//Public Declarations
		public:
			Stream( Mogre::Log^ target, Mogre::LogMessageLevel lml, bool maskDebug );
			Stream( Mogre::Log::Stream^ rhs );
			...
			DEFINE_MANAGED_NATIVE_CONVERSIONS_FOR_CLRHANDLE( Log::Stream )
	...
	public:
		...
		property bool IsTimeStampEnabled
		{
		public:
			bool get();
		}
		...
		Mogre::Log::Stream^ GetStream( Mogre::LogMessageLevel lml, bool maskDebug );
		Mogre::Log::Stream^ GetStream( Mogre::LogMessageLevel lml );
		Mogre::Log::Stream^ GetStream( );
