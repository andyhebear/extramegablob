...
namespace Mogre
{
	...
	public ref class ManualObject : public MovableObject
	{
		...
		public protected:
			...
			//Public Declarations
		public:
			ManualObjectSection( Mogre::ManualObject^ parent, String^ materialName, Mogre::RenderOperation::OperationTypes opType, String^ groupName );
			ManualObjectSection( Mogre::ManualObject^ parent, String^ materialName, Mogre::RenderOperation::OperationTypes opType );
	
	
			property String^ MaterialGroup
			{
			public:
				String^ get();
			}
	...
	public:
		...
		property bool KeepDeclarationOrder
		{
		public:
			bool get();
		public:
			void set(bool keepOrder);
		}
		...
		void TextureCoord( Mogre::Real x, Mogre::Real y, Mogre::Real z, Mogre::Real w );
		...
		void Index( Mogre::uint32 idx );
	
		void Triangle( Mogre::uint32 i1, Mogre::uint32 i2, Mogre::uint32 i3 );
	
		void Quad( Mogre::uint32 i1, Mogre::uint32 i2, Mogre::uint32 i3, Mogre::uint32 i4 );
