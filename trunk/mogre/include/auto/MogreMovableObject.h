...
namespace Mogre
{
	...
	public:
		...
		property bool IsDebugDisplayEnabled
		{
		public:
			bool get();
		}
		...
		property bool IsParentTagPoint
		{
		public:
			bool get();
		}
		...
		property Mogre::uint32 LightMask
		{
		public:
			Mogre::uint32 get();
		public:
			void set(Mogre::uint32 lightMask);
		}
		...
		void SetRenderQueueGroupAndPriority( Mogre::uint8 queueID, Mogre::ushort priority );
