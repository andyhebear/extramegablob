...
namespace Mogre
{
	...
	{
	public:
		delegate static void PreRenderQueuesHandler( );
		delegate static void PostRenderQueuesHandler( );
	...
	public:
		RenderQueueListener_Director( IRenderQueueListener_Receiver^ recv )
			: _receiver(recv), doCallForPreRenderQueues(false), doCallForPostRenderQueues(false), doCallForRenderQueueStarted(false), doCallForRenderQueueEnded(false)
		{
		}
	
		bool doCallForPreRenderQueues;
		bool doCallForPostRenderQueues;
