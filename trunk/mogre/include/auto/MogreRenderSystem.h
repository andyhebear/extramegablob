...
namespace Mogre
{
	...
	public:
		...
		property bool InvertVertexWinding
		{
		public:
			bool get();
		public:
			void set(bool invert);
		}
		...
		property bool VertexWindingInverted
		{
		public:
			bool get();
		}
		...
		Mogre::RenderWindow^ _initialise( bool autoCreateWindow, String^ windowTitle );
		Mogre::RenderWindow^ _initialise( bool autoCreateWindow );
	
		Mogre::RenderSystemCapabilities^ CreateRenderSystemCapabilities( );
		...
		Mogre::RenderWindow^ _createRenderWindow( String^ name, unsigned int width, unsigned int height, bool fullScreen, Mogre::Const_NameValuePairList^ miscParams );
		Mogre::RenderWindow^ _createRenderWindow( String^ name, unsigned int width, unsigned int height, bool fullScreen );
		...
		bool AreFixedFunctionLightsInViewSpace( );
		...
		void _setSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendOperation op );
		void _setSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor );
	
		void _setSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha, Mogre::SceneBlendOperation op, Mogre::SceneBlendOperation alphaOp );
		void _setSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha, Mogre::SceneBlendOperation op );
		void _setSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha );
	
		void _setAlphaRejectSettings( Mogre::CompareFunction func, unsigned char value, bool alphaToCoverage );
	
		void _setTextureProjectionRelativeTo( bool enabled, Mogre::Vector3 pos );
		...
		void BindGpuProgramParameters( Mogre::GpuProgramType gptype, Mogre::GpuProgramParametersSharedPtr^ params, Mogre::uint16 variabilityMask );
		...
		void AddClipPlane( Mogre::Plane p );
	
		void AddClipPlane( Mogre::Real A, Mogre::Real B, Mogre::Real C, Mogre::Real D );
		...
		void SetDeriveDepthBias( bool derive, float baseValue, float multiplier, float slopeScale );
		void SetDeriveDepthBias( bool derive, float baseValue, float multiplier );
		void SetDeriveDepthBias( bool derive, float baseValue );
		void SetDeriveDepthBias( bool derive );
	
		void _setRenderTarget( Mogre::RenderTarget^ target );
