...
namespace Mogre
{
	...
	public ref class SubMesh : public INativePointer
	{
		...
		public: INC_DECLARE_STLVECTOR( PointList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE, public: , private: )
		#undef STLDECL_MANAGEDTYPE
		#undef STLDECL_NATIVETYPE
	...
	private protected:
		...
		Mogre::SubMesh::PointList^ _extremityPoints;
	...
	public:
		...
		property Mogre::SubMesh::PointList^ extremityPoints
		{
		public:
			Mogre::SubMesh::PointList^ get();
		}
		...
		property bool IsBuildEdgesEnabled
		{
		public:
			bool get();
		}
		...
		void SetMaterialName( String^ matName, String^ groupName );
		...
		Mogre::SubMesh::Const_VertexBoneAssignmentList^ GetBoneAssignments( );
