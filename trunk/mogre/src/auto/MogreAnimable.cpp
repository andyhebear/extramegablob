...
namespace Mogre
{
	...
	void AnimableValue::_Init_CLRObject( )
	{
		static_cast<Ogre::AnimableValue*>(_native)->_Init_CLRObject( );
	}
	...
	void AnimableValue::SetValue( Mogre::Radian param1 )
	{
		static_cast<Ogre::AnimableValue*>(_native)->setValue( param1 );
	}
	
	void AnimableValue::SetValue( Mogre::Degree param1 )
	{
		static_cast<Ogre::AnimableValue*>(_native)->setValue( param1 );
	}
	...
	void AnimableValue::ApplyDeltaValue( Mogre::Degree param1 )
	{
		static_cast<Ogre::AnimableValue*>(_native)->applyDeltaValue( param1 );
	}
	
	void AnimableValue::ApplyDeltaValue( Mogre::Radian param1 )
	{
		static_cast<Ogre::AnimableValue*>(_native)->applyDeltaValue( param1 );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_AnimableValue(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::AnimableValue(pClrObj);
	}
