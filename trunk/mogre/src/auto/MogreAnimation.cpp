...
namespace Mogre
{
	...
	void Animation::Length::set( Mogre::Real len )
	{
		static_cast<Ogre::Animation*>(_native)->setLength( len );
	}
	...
	void Animation::_Init_CLRObject( )
	{
		static_cast<Ogre::Animation*>(_native)->_Init_CLRObject( );
	}
	...
	void Animation::ApplyToNode( Mogre::Node^ node, Mogre::Real timePos, Mogre::Real weight, Mogre::Real scale )
	{
		static_cast<Ogre::Animation*>(_native)->applyToNode( node, timePos, weight, scale );
	}
	void Animation::ApplyToNode( Mogre::Node^ node, Mogre::Real timePos, Mogre::Real weight )
	{
		static_cast<Ogre::Animation*>(_native)->applyToNode( node, timePos, weight );
	}
	void Animation::ApplyToNode( Mogre::Node^ node, Mogre::Real timePos )
	{
		static_cast<Ogre::Animation*>(_native)->applyToNode( node, timePos );
	}
	...
	void Animation::Apply( Mogre::Skeleton^ skeleton, Mogre::Real timePos, float weight, Mogre::AnimationState::Const_BoneBlendMask^ blendMask, Mogre::Real scale )
	{
		static_cast<Ogre::Animation*>(_native)->apply( skeleton, timePos, weight, blendMask, scale );
	}
	...
	void Animation::ApplyToAnimable( Mogre::AnimableValuePtr^ anim, Mogre::Real timePos, Mogre::Real weight, Mogre::Real scale )
	{
		static_cast<Ogre::Animation*>(_native)->applyToAnimable( (const Ogre::AnimableValuePtr&)anim, timePos, weight, scale );
	}
	void Animation::ApplyToAnimable( Mogre::AnimableValuePtr^ anim, Mogre::Real timePos, Mogre::Real weight )
	{
		static_cast<Ogre::Animation*>(_native)->applyToAnimable( (const Ogre::AnimableValuePtr&)anim, timePos, weight );
	}
	void Animation::ApplyToAnimable( Mogre::AnimableValuePtr^ anim, Mogre::Real timePos )
	{
		static_cast<Ogre::Animation*>(_native)->applyToAnimable( (const Ogre::AnimableValuePtr&)anim, timePos );
	}
	
	void Animation::ApplyToVertexData( Mogre::VertexData^ data, Mogre::Real timePos, Mogre::Real weight )
	{
		static_cast<Ogre::Animation*>(_native)->applyToVertexData( data, timePos, weight );
	}
	void Animation::ApplyToVertexData( Mogre::VertexData^ data, Mogre::Real timePos )
	{
		static_cast<Ogre::Animation*>(_native)->applyToVertexData( data, timePos );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Animation(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Animation(pClrObj);
	}
