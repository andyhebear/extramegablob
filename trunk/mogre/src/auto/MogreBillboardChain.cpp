...
namespace Mogre
{
	...
	void BillboardChain::_Init_CLRObject( )
	{
		static_cast<Ogre::BillboardChain*>(_native)->_Init_CLRObject( );
	}
	...
	size_t BillboardChain::GetNumChainElements( size_t chainIndex )
	{
		return static_cast<const Ogre::BillboardChain*>(_native)->getNumChainElements( chainIndex );
	}
	...
	void BillboardChain::SetMaterialName( String^ name, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::BillboardChain*>(_native)->setMaterialName( o_name, o_groupName );
	}
	void BillboardChain::SetMaterialName( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	...
	bool BillboardChain::PreRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		return static_cast<Ogre::BillboardChain*>(_native)->preRender( sm, rsys );
	}
	
	void BillboardChain::PostRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		static_cast<Ogre::BillboardChain*>(_native)->postRender( sm, rsys );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BillboardChain(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BillboardChain(pClrObj);
	}
	...
	void BillboardChainFactory::_Init_CLRObject( )
	{
		static_cast<Ogre::BillboardChainFactory*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BillboardChainFactory(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BillboardChainFactory(pClrObj);
	}
