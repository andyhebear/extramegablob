...
namespace Mogre
{
	...
	bool BillboardSet::AutoUpdate::get()
	{
		return static_cast<const Ogre::BillboardSet*>(_native)->getAutoUpdate( );
	}
	void BillboardSet::AutoUpdate::set( bool autoUpdate )
	{
		static_cast<Ogre::BillboardSet*>(_native)->setAutoUpdate( autoUpdate );
	}
	...
	void BillboardSet::_Init_CLRObject( )
	{
		static_cast<Ogre::BillboardSet*>(_native)->_Init_CLRObject( );
	}
	...
	void BillboardSet::SetMaterialName( String^ name, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::BillboardSet*>(_native)->setMaterialName( o_name, o_groupName );
	}
	...
	void BillboardSet::NotifyBillboardDataChanged( )
	{
		static_cast<Ogre::BillboardSet*>(_native)->notifyBillboardDataChanged( );
	}
	...
	bool BillboardSet::PreRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		return static_cast<Ogre::BillboardSet*>(_native)->preRender( sm, rsys );
	}
	
	void BillboardSet::PostRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		static_cast<Ogre::BillboardSet*>(_native)->postRender( sm, rsys );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BillboardSet(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BillboardSet(pClrObj);
	}
	...
	void BillboardSetFactory::_Init_CLRObject( )
	{
		static_cast<Ogre::BillboardSetFactory*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BillboardSetFactory(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BillboardSetFactory(pClrObj);
	}
