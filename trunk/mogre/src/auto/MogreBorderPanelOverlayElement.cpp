...
namespace Mogre
{
	...
	void BorderPanelOverlayElement::_Init_CLRObject( )
	{
		static_cast<Ogre::BorderPanelOverlayElement*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BorderPanelOverlayElement(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BorderPanelOverlayElement(pClrObj);
	}
	...
	void BorderRenderable::_Init_CLRObject( )
	{
		static_cast<Ogre::BorderRenderable*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::UserObjectBindings^ BorderRenderable::UserObjectBindings::get()
	{
		return static_cast<Ogre::BorderRenderable*>(_native)->getUserObjectBindings( );
	}
	
	bool BorderRenderable::PreRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		return static_cast<Ogre::BorderRenderable*>(_native)->preRender( sm, rsys );
	}
	
	void BorderRenderable::PostRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		static_cast<Ogre::BorderRenderable*>(_native)->postRender( sm, rsys );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_BorderRenderable(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::BorderRenderable(pClrObj);
	}
