...
namespace Mogre
{
	...
	CLRHandle CompositionTargetPass::_CLRHandle::get()
	{
		return static_cast<Ogre::CompositionTargetPass*>(_native)->_CLRHandle;
	}
	void CompositionTargetPass::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::CompositionTargetPass*>(_native)->_CLRHandle = value;
	}
