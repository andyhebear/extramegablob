...
namespace Mogre
{
	...
	bool DataStream::IsReadable::get()
	{
		return static_cast<const Ogre::DataStream*>(_native)->isReadable( );
	}
	
	bool DataStream::IsWriteable::get()
	{
		return static_cast<const Ogre::DataStream*>(_native)->isWriteable( );
	}
	...
	Mogre::uint16 DataStream::GetAccessMode( )
	{
		return static_cast<const Ogre::DataStream*>(_native)->getAccessMode( );
	}
	...
	{
		return static_cast<Ogre::DataStream*>(_native)->write( buf, count );
	}
	...
	{
		return static_cast<Ogre::MemoryDataStream*>(_native)->write( buf, count );
	}
