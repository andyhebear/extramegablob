...
namespace Mogre
{
	...
	CLRHandle EdgeData::_CLRHandle::get()
	{
		return static_cast<Ogre::EdgeData*>(_native)->_CLRHandle;
	}
	void EdgeData::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::EdgeData*>(_native)->_CLRHandle = value;
	}
