...
namespace Mogre
{
	...
	Mogre::ushort Entity::CurrentLodIndex::get()
	{
		return static_cast<Ogre::Entity*>(_native)->getCurrentLodIndex( );
	}
	...
	bool Entity::SkipAnimationStateUpdate::get()
	{
		return static_cast<const Ogre::Entity*>(_native)->getSkipAnimationStateUpdate( );
	}
	void Entity::SkipAnimationStateUpdate::set( bool skip )
	{
		static_cast<Ogre::Entity*>(_native)->setSkipAnimationStateUpdate( skip );
	}
	...
	void Entity::_Init_CLRObject( )
	{
		static_cast<Ogre::Entity*>(_native)->_Init_CLRObject( );
	}
	...
	void Entity::SetMaterialName( String^ name, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::Entity*>(_native)->setMaterialName( o_name, o_groupName );
	}
	...
	void Entity::SetMaterial( Mogre::MaterialPtr^ material )
	{
		static_cast<Ogre::Entity*>(_native)->setMaterial( (const Ogre::MaterialPtr&)material );
	}
	...
	void Entity::SetRenderQueueGroupAndPriority( Mogre::uint8 queueID, Mogre::ushort priority )
	{
		static_cast<Ogre::Entity*>(_native)->setRenderQueueGroupAndPriority( queueID, priority );
	}
	...
	Mogre::Real Entity::_getMeshLodFactorTransformed( )
	{
		return static_cast<const Ogre::Entity*>(_native)->_getMeshLodFactorTransformed( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Entity(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Entity(pClrObj);
	}
	...
	void EntityFactory::_Init_CLRObject( )
	{
		static_cast<Ogre::EntityFactory*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_EntityFactory(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::EntityFactory(pClrObj);
	}
