...
namespace Mogre
{
	...
	int Font::TrueTypeMaxBearingY::get()
	{
		return static_cast<const Ogre::Font*>(_native)->getTrueTypeMaxBearingY( );
	}
	...
	void Font::_Init_CLRObject( )
	{
		static_cast<Ogre::Font*>(_native)->_Init_CLRObject( );
	}
	...
	void Font::PrepareResource( Mogre::Resource^ resource )
	{
		static_cast<Ogre::Font*>(_native)->prepareResource( resource );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Font(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Font(pClrObj);
	}
