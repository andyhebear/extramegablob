...
namespace Mogre
{
	...
	//Public Declarations
	Mogre::HardwareBufferManagerBase^ HardwareVertexBuffer::Manager::get()
	{
		return static_cast<const Ogre::HardwareVertexBuffer*>(_native)->getManager( );
	}
	...
	void HardwareVertexBuffer::_Init_CLRObject( )
	{
		static_cast<Ogre::HardwareVertexBuffer*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_HardwareVertexBuffer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::HardwareVertexBuffer(pClrObj);
	}
	...
	void VertexDeclaration::_Init_CLRObject( )
	{
		static_cast<Ogre::VertexDeclaration*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::VertexDeclaration^ VertexDeclaration::Clone( Mogre::HardwareBufferManagerBase^ mgr )
	{
		return static_cast<Ogre::VertexDeclaration*>(_native)->clone( mgr );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_VertexDeclaration(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::VertexDeclaration(pClrObj);
	}
	...
	void VertexBufferBinding::_Init_CLRObject( )
	{
		static_cast<Ogre::VertexBufferBinding*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_VertexBufferBinding(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::VertexBufferBinding(pClrObj);
	}
