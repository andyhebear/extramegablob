...
namespace Mogre
{
	...
	CLRHandle Image::_CLRHandle::get()
	{
		return static_cast<Ogre::Image*>(_native)->_CLRHandle;
	}
	void Image::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::Image*>(_native)->_CLRHandle = value;
	}
	...
	Mogre::Image^ Image::Load( Mogre::DataStreamPtr^ stream )
	{
		return static_cast<Ogre::Image*>(_native)->load( (Ogre::DataStreamPtr&)stream );
	}
	
	Mogre::Image^ Image::LoadTwoImagesAsRGBA( String^ rgbFilename, String^ alphaFilename, String^ groupName, Mogre::PixelFormat format )
	{
		DECLARE_NATIVE_STRING( o_rgbFilename, rgbFilename )
		DECLARE_NATIVE_STRING( o_alphaFilename, alphaFilename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::Image*>(_native)->loadTwoImagesAsRGBA( o_rgbFilename, o_alphaFilename, o_groupName, (Ogre::PixelFormat)format );
	}
	Mogre::Image^ Image::LoadTwoImagesAsRGBA( String^ rgbFilename, String^ alphaFilename, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_rgbFilename, rgbFilename )
		DECLARE_NATIVE_STRING( o_alphaFilename, alphaFilename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::Image*>(_native)->loadTwoImagesAsRGBA( o_rgbFilename, o_alphaFilename, o_groupName );
	}
	
	Mogre::Image^ Image::LoadTwoImagesAsRGBA( Mogre::DataStreamPtr^ rgbStream, Mogre::DataStreamPtr^ alphaStream, Mogre::PixelFormat PF_BYTE_RGBA, String^ rgbType, String^ alphaType )
	{
		DECLARE_NATIVE_STRING( o_rgbType, rgbType )
		DECLARE_NATIVE_STRING( o_alphaType, alphaType )
	
		return static_cast<Ogre::Image*>(_native)->loadTwoImagesAsRGBA( (Ogre::DataStreamPtr&)rgbStream, (Ogre::DataStreamPtr&)alphaStream, (Ogre::PixelFormat)PF_BYTE_RGBA, o_rgbType, o_alphaType );
	}
	Mogre::Image^ Image::LoadTwoImagesAsRGBA( Mogre::DataStreamPtr^ rgbStream, Mogre::DataStreamPtr^ alphaStream, Mogre::PixelFormat PF_BYTE_RGBA, String^ rgbType )
	{
		DECLARE_NATIVE_STRING( o_rgbType, rgbType )
	
		return static_cast<Ogre::Image*>(_native)->loadTwoImagesAsRGBA( (Ogre::DataStreamPtr&)rgbStream, (Ogre::DataStreamPtr&)alphaStream, (Ogre::PixelFormat)PF_BYTE_RGBA, o_rgbType );
	}
	Mogre::Image^ Image::LoadTwoImagesAsRGBA( Mogre::DataStreamPtr^ rgbStream, Mogre::DataStreamPtr^ alphaStream, Mogre::PixelFormat PF_BYTE_RGBA )
	{
		return static_cast<Ogre::Image*>(_native)->loadTwoImagesAsRGBA( (Ogre::DataStreamPtr&)rgbStream, (Ogre::DataStreamPtr&)alphaStream, (Ogre::PixelFormat)PF_BYTE_RGBA );
	}
	
	Mogre::Image^ Image::CombineTwoImagesAsRGBA( Mogre::Image^ rgb, Mogre::Image^ alpha, Mogre::PixelFormat format )
	{
		return static_cast<Ogre::Image*>(_native)->combineTwoImagesAsRGBA( rgb, alpha, (Ogre::PixelFormat)format );
	}
	Mogre::Image^ Image::CombineTwoImagesAsRGBA( Mogre::Image^ rgb, Mogre::Image^ alpha )
	{
		return static_cast<Ogre::Image*>(_native)->combineTwoImagesAsRGBA( rgb, alpha );
	}
	...
	Mogre::DataStreamPtr^ Image::Encode( String^ formatextension )
	{
		DECLARE_NATIVE_STRING( o_formatextension, formatextension )
	
		return static_cast<Ogre::Image*>(_native)->encode( o_formatextension );
	}
	...
	{
		return static_cast<const Ogre::Image*>(_native)->getColourAt( x, y, z );
	}
	...
	{
		static_cast<Ogre::Image*>(_native)->freeMemory( );
	}
	...
	String^ Image::GetFileExtFromMagic( Mogre::DataStreamPtr^ stream )
	{
		return TO_CLR_STRING( Ogre::Image::getFileExtFromMagic( (Ogre::DataStreamPtr)stream ) );
	}
