...
namespace Mogre
{
	...
	Mogre::Log::Stream^ LogManager::Stream( Mogre::LogMessageLevel lml, bool maskDebug )
	{
		return static_cast<Ogre::LogManager*>(_native)->stream( (Ogre::LogMessageLevel)lml, maskDebug );
	}
	Mogre::Log::Stream^ LogManager::Stream( Mogre::LogMessageLevel lml )
	{
		return static_cast<Ogre::LogManager*>(_native)->stream( (Ogre::LogMessageLevel)lml );
	}
	Mogre::Log::Stream^ LogManager::Stream( )
	{
		return static_cast<Ogre::LogManager*>(_native)->stream( );
	}
