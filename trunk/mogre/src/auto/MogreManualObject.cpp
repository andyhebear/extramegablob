...
namespace Mogre
{
	...
	//Public Declarations
	ManualObject::ManualObjectSection::ManualObjectSection( Mogre::ManualObject^ parent, String^ materialName, Mogre::RenderOperation::OperationTypes opType, String^ groupName ) : Wrapper((CLRObject*) 0)
	{
		_createdByCLR = true;
		DECLARE_NATIVE_STRING( o_materialName, materialName )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		_native = new Ogre::ManualObject::ManualObjectSection( parent, o_materialName, (Ogre::RenderOperation::OperationType)opType, o_groupName);
	...
	String^ ManualObject::ManualObjectSection::MaterialGroup::get()
	{
		return TO_CLR_STRING( static_cast<const Ogre::ManualObject::ManualObjectSection*>(_native)->getMaterialGroup( ) );
	}
	...
	void ManualObject::ManualObjectSection::_Init_CLRObject( )
	{
		static_cast<Ogre::ManualObject::ManualObjectSection*>(_native)->_Init_CLRObject( );
	}
	
	void ManualObject::ManualObjectSection::SetMaterialName( String^ name, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::ManualObject::ManualObjectSection*>(_native)->setMaterialName( o_name, o_groupName );
	}
	void ManualObject::ManualObjectSection::SetMaterialName( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	...
	void ManualObject::ManualObjectSection::Set32BitIndices( bool n32 )
	{
		static_cast<Ogre::ManualObject::ManualObjectSection*>(_native)->set32BitIndices( n32 );
	}
	
	bool ManualObject::ManualObjectSection::Get32BitIndices( )
	{
		return static_cast<const Ogre::ManualObject::ManualObjectSection*>(_native)->get32BitIndices( );
	}
	...
	Mogre::UserObjectBindings^ ManualObject::ManualObjectSection::UserObjectBindings::get()
	{
		return static_cast<Ogre::ManualObject::ManualObjectSection*>(_native)->getUserObjectBindings( );
	}
	
	bool ManualObject::ManualObjectSection::PreRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		return static_cast<Ogre::ManualObject::ManualObjectSection*>(_native)->preRender( sm, rsys );
	}
	
	void ManualObject::ManualObjectSection::PostRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		static_cast<Ogre::ManualObject::ManualObjectSection*>(_native)->postRender( sm, rsys );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ManualObject_ManualObjectSection(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ManualObject::ManualObjectSection(pClrObj);
	}
	...
	void ManualObject::ManualObjectSectionShadowRenderable::_Init_CLRObject( )
	{
		static_cast<Ogre::ManualObject::ManualObjectSectionShadowRenderable*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ManualObject_ManualObjectSectionShadowRenderable(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ManualObject::ManualObjectSectionShadowRenderable(pClrObj);
	}
	...
	bool ManualObject::KeepDeclarationOrder::get()
	{
		return static_cast<const Ogre::ManualObject*>(_native)->getKeepDeclarationOrder( );
	}
	void ManualObject::KeepDeclarationOrder::set( bool keepOrder )
	{
		static_cast<Ogre::ManualObject*>(_native)->setKeepDeclarationOrder( keepOrder );
	}
	...
	void ManualObject::TextureCoord( Mogre::Real x, Mogre::Real y, Mogre::Real z, Mogre::Real w )
	{
	...
	{
		static_cast<Ogre::ManualObject*>(_native)->textureCoord( xyzw );
	}
	...
	void ManualObject::Index( Mogre::uint32 idx )
	{
		static_cast<Ogre::ManualObject*>(_native)->index( idx );
	}
	
	void ManualObject::Triangle( Mogre::uint32 i1, Mogre::uint32 i2, Mogre::uint32 i3 )
	{
		static_cast<Ogre::ManualObject*>(_native)->triangle( i1, i2, i3 );
	}
	
	void ManualObject::Quad( Mogre::uint32 i1, Mogre::uint32 i2, Mogre::uint32 i3, Mogre::uint32 i4 )
	{
	...
	__declspec(dllexport) void _Init_CLRObject_ManualObject(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ManualObject(pClrObj);
	}
	...
	void ManualObjectFactory::_Init_CLRObject( )
	{
		static_cast<Ogre::ManualObjectFactory*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ManualObjectFactory(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ManualObjectFactory(pClrObj);
	}
