...
namespace Mogre
{
	...
	CPP_DECLARE_STLVECTOR( Material::, LodValueList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE )
	#undef STLDECL_MANAGEDTYPE
	#undef STLDECL_NATIVETYPE
	
	CPP_DECLARE_ITERATOR( Material::, LodValueIterator, Ogre::Material::LodValueIterator, Mogre::Material::LodValueList, Mogre::Real, Ogre::Real,  )
	...
	Mogre::LodStrategy^ Material::LodStrategy::get()
	{
		return static_cast<const Ogre::Material*>(_native)->getLodStrategy( );
	}
	void Material::LodStrategy::set( Mogre::LodStrategy^ lodStrategy )
	{
		static_cast<Ogre::Material*>(_native)->setLodStrategy( lodStrategy );
	}
	...
	void Material::_Init_CLRObject( )
	{
		static_cast<Ogre::Material*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::Technique^ Material::GetBestTechnique( unsigned short lodIndex, Mogre::IRenderable^ rend )
	{
		return static_cast<Ogre::Material*>(_native)->getBestTechnique( lodIndex, rend );
	}
	...
	void Material::SetSeparateSceneBlending( Mogre::SceneBlendType sbt, Mogre::SceneBlendType sbta )
	{
		static_cast<Ogre::Material*>(_native)->setSeparateSceneBlending( (Ogre::SceneBlendType)sbt, (Ogre::SceneBlendType)sbta );
	}
	...
	void Material::SetSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha )
	{
		static_cast<Ogre::Material*>(_native)->setSeparateSceneBlending( (Ogre::SceneBlendFactor)sourceFactor, (Ogre::SceneBlendFactor)destFactor, (Ogre::SceneBlendFactor)sourceFactorAlpha, (Ogre::SceneBlendFactor)destFactorAlpha );
	}
	...
	void Material::SetLodLevels( Mogre::Material::Const_LodValueList^ lodValues )
	{
		static_cast<Ogre::Material*>(_native)->setLodLevels( lodValues );
	}
	
	Mogre::Material::LodValueIterator^ Material::GetLodValueIterator( )
	{
		return static_cast<const Ogre::Material*>(_native)->getLodValueIterator( );
	}
	
	Mogre::ushort Material::GetLodIndex( Mogre::Real value )
	{
		return static_cast<const Ogre::Material*>(_native)->getLodIndex( value );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Material(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Material(pClrObj);
	}
