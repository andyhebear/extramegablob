...
namespace Mogre
{
	...
	Mogre::IMeshSerializerListener^ MeshManager::Listener::get()
	{
		return static_cast<Ogre::MeshManager*>(_native)->getListener( );
	}
	void MeshManager::Listener::set( Mogre::IMeshSerializerListener^ listener )
	{
		static_cast<Ogre::MeshManager*>(_native)->setListener( listener );
	}
	...
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ params, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexBufferShadowed, bool indexBufferShadowed )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group, isManual, loader, params, (Ogre::HardwareBuffer::Usage)vertexBufferUsage, (Ogre::HardwareBuffer::Usage)indexBufferUsage, vertexBufferShadowed, indexBufferShadowed ) );
	}
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ params, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexBufferShadowed )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	...
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ params, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group, isManual, loader, params, (Ogre::HardwareBuffer::Usage)vertexBufferUsage, (Ogre::HardwareBuffer::Usage)indexBufferUsage ) );
	}
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ params, Mogre::HardwareBuffer::Usage vertexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group, isManual, loader, params, (Ogre::HardwareBuffer::Usage)vertexBufferUsage ) );
	}
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader, Mogre::Const_NameValuePairList^ params )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		...
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group, isManual, loader, params ) );
	}
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual, Mogre::IManualResourceLoader^ loader )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group, isManual, loader ) );
	}
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group, bool isManual )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group, isManual ) );
	}
	Pair<Mogre::ResourcePtr^, bool> MeshManager::CreateOrRetrieve( String^ name, String^ group )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_group, group )
	
		return ToManaged<Pair<Mogre::ResourcePtr^, bool>, Ogre::ResourceManager::ResourceCreateOrRetrieveResult>( static_cast<Ogre::MeshManager*>(_native)->createOrRetrieve( o_name, o_group ) );
	}
	
	Mogre::MeshPtr^ MeshManager::Prepare( String^ filename, String^ groupName, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexBufferShadowed, bool indexBufferShadowed )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::MeshManager*>(_native)->prepare( o_filename, o_groupName, (Ogre::HardwareBuffer::Usage)vertexBufferUsage, (Ogre::HardwareBuffer::Usage)indexBufferUsage, vertexBufferShadowed, indexBufferShadowed );
	}
	Mogre::MeshPtr^ MeshManager::Prepare( String^ filename, String^ groupName, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexBufferShadowed )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::MeshManager*>(_native)->prepare( o_filename, o_groupName, (Ogre::HardwareBuffer::Usage)vertexBufferUsage, (Ogre::HardwareBuffer::Usage)indexBufferUsage, vertexBufferShadowed );
	}
	Mogre::MeshPtr^ MeshManager::Prepare( String^ filename, String^ groupName, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::MeshManager*>(_native)->prepare( o_filename, o_groupName, (Ogre::HardwareBuffer::Usage)vertexBufferUsage, (Ogre::HardwareBuffer::Usage)indexBufferUsage );
	}
	Mogre::MeshPtr^ MeshManager::Prepare( String^ filename, String^ groupName, Mogre::HardwareBuffer::Usage vertexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::MeshManager*>(_native)->prepare( o_filename, o_groupName, (Ogre::HardwareBuffer::Usage)vertexBufferUsage );
	}
	Mogre::MeshPtr^ MeshManager::Prepare( String^ filename, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_filename, filename )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		return static_cast<Ogre::MeshManager*>(_native)->prepare( o_filename, o_groupName );
	}
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexShadowBuffer, bool indexShadowBuffer )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexShadowBuffer )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::HardwareBuffer::Usage vertexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreatePlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::Quaternion orientation, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexShadowBuffer, bool indexShadowBuffer, int ySegmentsToKeep )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::Quaternion orientation, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexShadowBuffer, bool indexShadowBuffer )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::Quaternion orientation, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexShadowBuffer )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::Quaternion orientation, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::Quaternion orientation, Mogre::HardwareBuffer::Usage vertexBufferUsage )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector, Mogre::Quaternion orientation )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile, Mogre::Vector3 upVector )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile, Mogre::Real vTile )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real uTile )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedIllusionPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real curvature, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real bow, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real xTile, Mogre::Real yTile, Mogre::Vector3 upVector, Mogre::HardwareBuffer::Usage vertexBufferUsage, Mogre::HardwareBuffer::Usage indexBufferUsage, bool vertexShadowBuffer, bool indexShadowBuffer )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real bow, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real xTile, Mogre::Real yTile, Mogre::Vector3 upVector )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real bow, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets, Mogre::Real xTile, Mogre::Real yTile )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	Mogre::MeshPtr^ MeshManager::CreateCurvedPlane( String^ name, String^ groupName, Mogre::Plane plane, Mogre::Real width, Mogre::Real height, Mogre::Real bow, int xsegments, int ysegments, bool normals, unsigned short numTexCoordSets )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	...
	void MeshManager::PrepareResource( Mogre::Resource^ resource )
	{
		static_cast<Ogre::MeshManager*>(_native)->prepareResource( resource );
	}
