...
namespace Mogre
{
	...
	void MovablePlane::_Init_CLRObject( )
	{
		static_cast<Ogre::MovablePlane*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_MovablePlane(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::MovablePlane(pClrObj);
	}
