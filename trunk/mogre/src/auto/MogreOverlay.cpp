...
namespace Mogre
{
	...
	void Overlay::_Init_CLRObject( )
	{
		static_cast<Ogre::Overlay*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Overlay(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Overlay(pClrObj);
	}
