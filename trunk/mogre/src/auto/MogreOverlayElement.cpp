...
namespace Mogre
{
	...
	void OverlayElement::_Init_CLRObject( )
	{
		static_cast<Ogre::OverlayElement*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::ushort OverlayElement::_notifyZOrder( Mogre::ushort newZOrder )
	{
		return static_cast<Ogre::OverlayElement*>(_native)->_notifyZOrder( newZOrder );
	}
	...
	Mogre::UserObjectBindings^ OverlayElement::UserObjectBindings::get()
	{
		return static_cast<Ogre::OverlayElement*>(_native)->getUserObjectBindings( );
	}
	...
	bool OverlayElement::PreRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		return static_cast<Ogre::OverlayElement*>(_native)->preRender( sm, rsys );
	}
	
	void OverlayElement::PostRender( Mogre::SceneManager^ sm, Mogre::RenderSystem^ rsys )
	{
		static_cast<Ogre::OverlayElement*>(_native)->postRender( sm, rsys );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_OverlayElement(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::OverlayElement(pClrObj);
	}
