...
namespace Mogre
{
	...
	bool ParticleSystem::Emitting::get()
	{
		return static_cast<const Ogre::ParticleSystem*>(_native)->getEmitting( );
	}
	void ParticleSystem::Emitting::set( bool v )
	{
		static_cast<Ogre::ParticleSystem*>(_native)->setEmitting( v );
	}
	...
	void ParticleSystem::_Init_CLRObject( )
	{
		static_cast<Ogre::ParticleSystem*>(_native)->_Init_CLRObject( );
	}
	...
	void ParticleSystem::SetMaterialName( String^ name, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_name, name )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::ParticleSystem*>(_native)->setMaterialName( o_name, o_groupName );
	}
	void ParticleSystem::SetMaterialName( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	...
	__declspec(dllexport) void _Init_CLRObject_ParticleSystem(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ParticleSystem(pClrObj);
	}
