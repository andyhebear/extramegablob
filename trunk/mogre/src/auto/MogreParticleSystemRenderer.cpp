...
namespace Mogre
{
	...
	void ParticleSystemRenderer::_Init_CLRObject( )
	{
		static_cast<Ogre::ParticleSystemRenderer*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_ParticleSystemRenderer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::ParticleSystemRenderer(pClrObj);
	}
