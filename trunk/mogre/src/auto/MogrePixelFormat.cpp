...
namespace Mogre
{
	...
	Mogre::PixelFormat PixelUtil::GetFormatForBitDepths( Mogre::PixelFormat fmt, Mogre::ushort integerBits, Mogre::ushort floatBits )
	{
		return (Mogre::PixelFormat)Ogre::PixelUtil::getFormatForBitDepths( (Ogre::PixelFormat)fmt, integerBits, floatBits );
	}
	
	void PixelUtil::PackColour( Mogre::ColourValue colour, Mogre::PixelFormat pf, void* dest )
	{
		Ogre::PixelUtil::packColour( colour, (Ogre::PixelFormat)pf, dest );
	}
	
	void PixelUtil::PackColour( Mogre::uint8 r, Mogre::uint8 g, Mogre::uint8 b, Mogre::uint8 a, Mogre::PixelFormat pf, void* dest )
	{
	...
	void PixelUtil::UnpackColour( Mogre::ColourValue* colour, Mogre::PixelFormat pf, const void* src )
	{
	...
	void PixelUtil::UnpackColour( [Out] Mogre::uint8% r, [Out] Mogre::uint8% g, [Out] Mogre::uint8% b, [Out] Mogre::uint8% a, Mogre::PixelFormat pf, const void* src )
	{
		pin_ptr<Mogre::uint8> p_r = &r;
		pin_ptr<Mogre::uint8> p_g = &g;
		pin_ptr<Mogre::uint8> p_b = &b;
		pin_ptr<Mogre::uint8> p_a = &a;
	...
	#define STLDECL_MANAGEDTYPE Mogre::PixelFormat
	#define STLDECL_NATIVETYPE Ogre::PixelFormat
	CPP_DECLARE_STLVECTOR( , PixelFormatList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE )
