...
namespace Mogre
{
	...
	CLRHandle PlaneBoundedVolume::_CLRHandle::get()
	{
		return static_cast<Ogre::PlaneBoundedVolume*>(_native)->_CLRHandle;
	}
	void PlaneBoundedVolume::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::PlaneBoundedVolume*>(_native)->_CLRHandle = value;
	}
