...
namespace Mogre
{
	...
	void Pose::_Init_CLRObject( )
	{
		static_cast<Ogre::Pose*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Pose(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Pose(pClrObj);
	}
