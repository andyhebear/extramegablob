...
namespace Mogre
{
	...
	CLRHandle RenderOperation::_CLRHandle::get()
	{
		return static_cast<Ogre::RenderOperation*>(_native)->_CLRHandle;
	}
	void RenderOperation::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::RenderOperation*>(_native)->_CLRHandle = value;
	}
