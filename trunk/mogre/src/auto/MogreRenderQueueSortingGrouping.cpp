...
namespace Mogre
{
	...
	void QueuedRenderableCollection::Merge( Mogre::QueuedRenderableCollection^ rhs )
	{
		static_cast<Ogre::QueuedRenderableCollection*>(_native)->merge( rhs );
	}
	...
	CLRHandle RenderPriorityGroup::_CLRHandle::get()
	{
		return static_cast<Ogre::RenderPriorityGroup*>(_native)->_CLRHandle;
	}
	void RenderPriorityGroup::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::RenderPriorityGroup*>(_native)->_CLRHandle = value;
	}
	...
	Mogre::QueuedRenderableCollection^ RenderPriorityGroup::TransparentsUnsorted::get()
	{
		return static_cast<const Ogre::RenderPriorityGroup*>(_native)->getTransparentsUnsorted( );
	}
	...
	void RenderPriorityGroup::Merge( Mogre::RenderPriorityGroup^ rhs )
	{
		static_cast<Ogre::RenderPriorityGroup*>(_native)->merge( rhs );
	}
	...
	CLRHandle RenderQueueGroup::_CLRHandle::get()
	{
		return static_cast<Ogre::RenderQueueGroup*>(_native)->_CLRHandle;
	}
	void RenderQueueGroup::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::RenderQueueGroup*>(_native)->_CLRHandle = value;
	}
	...
	void RenderQueueGroup::Merge( Mogre::RenderQueueGroup^ rhs )
	{
		static_cast<Ogre::RenderQueueGroup*>(_native)->merge( rhs );
	}
	...
	void QueuedRenderableVisitor_Proxy::visit( Ogre::RenderablePass* rp )
	{
		_managed->Visit( rp );
	}
	...
	void QueuedRenderableVisitor_Proxy::visit( Ogre::Renderable* r )
	{
		_managed->Visit( r );
	}
