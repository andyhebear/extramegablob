...
namespace Mogre
{
	...
	unsigned int RenderSystem::DisplayMonitorCount::get()
	{
		return static_cast<const Ogre::RenderSystem*>(_native)->getDisplayMonitorCount( );
	}
	
	Mogre::DriverVersion RenderSystem::DriverVersion::get()
	{
		return static_cast<const Ogre::RenderSystem*>(_native)->getDriverVersion( );
	}
	...
	bool RenderSystem::InvertVertexWinding::get()
	{
		return static_cast<Ogre::RenderSystem*>(_native)->getInvertVertexWinding( );
	}
	void RenderSystem::InvertVertexWinding::set( bool invert )
	{
	...
	bool RenderSystem::VertexWindingInverted::get()
	{
		return static_cast<const Ogre::RenderSystem*>(_native)->getVertexWindingInverted( );
	}
	...
	void RenderSystem::_Init_CLRObject( )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::RenderWindow^ RenderSystem::_initialise( bool autoCreateWindow, String^ windowTitle )
	{
		DECLARE_NATIVE_STRING( o_windowTitle, windowTitle )
	
		return static_cast<Ogre::RenderSystem*>(_native)->_initialise( autoCreateWindow, o_windowTitle );
	}
	Mogre::RenderWindow^ RenderSystem::_initialise( bool autoCreateWindow )
	{
		return static_cast<Ogre::RenderSystem*>(_native)->_initialise( autoCreateWindow );
	}
	
	Mogre::RenderSystemCapabilities^ RenderSystem::CreateRenderSystemCapabilities( )
	{
		return static_cast<const Ogre::RenderSystem*>(_native)->createRenderSystemCapabilities( );
	}
	
	void RenderSystem::UseCustomRenderSystemCapabilities( Mogre::RenderSystemCapabilities^ capabilities )
	{
		static_cast<Ogre::RenderSystem*>(_native)->useCustomRenderSystemCapabilities( capabilities );
	}
	...
	Mogre::RenderWindow^ RenderSystem::_createRenderWindow( String^ name, unsigned int width, unsigned int height, bool fullScreen, Mogre::Const_NameValuePairList^ miscParams )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		return static_cast<Ogre::RenderSystem*>(_native)->_createRenderWindow( o_name, width, height, fullScreen, miscParams );
	}
	Mogre::RenderWindow^ RenderSystem::_createRenderWindow( String^ name, unsigned int width, unsigned int height, bool fullScreen )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		return static_cast<Ogre::RenderSystem*>(_native)->_createRenderWindow( o_name, width, height, fullScreen );
	}
	...
	bool RenderSystem::AreFixedFunctionLightsInViewSpace( )
	{
		return static_cast<const Ogre::RenderSystem*>(_native)->areFixedFunctionLightsInViewSpace( );
	}
	...
	void RenderSystem::_setSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendOperation op )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_setSceneBlending( (Ogre::SceneBlendFactor)sourceFactor, (Ogre::SceneBlendFactor)destFactor, (Ogre::SceneBlendOperation)op );
	}
	...
	void RenderSystem::_setSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha, Mogre::SceneBlendOperation op, Mogre::SceneBlendOperation alphaOp )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_setSeparateSceneBlending( (Ogre::SceneBlendFactor)sourceFactor, (Ogre::SceneBlendFactor)destFactor, (Ogre::SceneBlendFactor)sourceFactorAlpha, (Ogre::SceneBlendFactor)destFactorAlpha, (Ogre::SceneBlendOperation)op, (Ogre::SceneBlendOperation)alphaOp );
	}
	void RenderSystem::_setSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha, Mogre::SceneBlendOperation op )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_setSeparateSceneBlending( (Ogre::SceneBlendFactor)sourceFactor, (Ogre::SceneBlendFactor)destFactor, (Ogre::SceneBlendFactor)sourceFactorAlpha, (Ogre::SceneBlendFactor)destFactorAlpha, (Ogre::SceneBlendOperation)op );
	}
	void RenderSystem::_setSeparateSceneBlending( Mogre::SceneBlendFactor sourceFactor, Mogre::SceneBlendFactor destFactor, Mogre::SceneBlendFactor sourceFactorAlpha, Mogre::SceneBlendFactor destFactorAlpha )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_setSeparateSceneBlending( (Ogre::SceneBlendFactor)sourceFactor, (Ogre::SceneBlendFactor)destFactor, (Ogre::SceneBlendFactor)sourceFactorAlpha, (Ogre::SceneBlendFactor)destFactorAlpha );
	}
	...
	void RenderSystem::_setTextureProjectionRelativeTo( bool enabled, Mogre::Vector3 pos )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_setTextureProjectionRelativeTo( enabled, pos );
	}
	...
	void RenderSystem::BindGpuProgramParameters( Mogre::GpuProgramType gptype, Mogre::GpuProgramParametersSharedPtr^ params, Mogre::uint16 variabilityMask )
	{
	...
	void RenderSystem::AddClipPlane( Mogre::Plane p )
	{
		static_cast<Ogre::RenderSystem*>(_native)->addClipPlane( p );
	}
	
	void RenderSystem::AddClipPlane( Mogre::Real A, Mogre::Real B, Mogre::Real C, Mogre::Real D )
	{
		static_cast<Ogre::RenderSystem*>(_native)->addClipPlane( A, B, C, D );
	}
	
	void RenderSystem::ResetClipPlanes( )
	{
		static_cast<Ogre::RenderSystem*>(_native)->resetClipPlanes( );
	}
	...
	{
		static_cast<Ogre::RenderSystem*>(_native)->_updateAllRenderTargets( swapBuffers );
	}
	...
	{
		static_cast<Ogre::RenderSystem*>(_native)->_swapAllRenderTargetBuffers( waitForVsync );
	}
	void RenderSystem::_swapAllRenderTargetBuffers( )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_swapAllRenderTargetBuffers( );
	}
	...
	void RenderSystem::SetDeriveDepthBias( bool derive, float baseValue, float multiplier, float slopeScale )
	{
		static_cast<Ogre::RenderSystem*>(_native)->setDeriveDepthBias( derive, baseValue, multiplier, slopeScale );
	}
	void RenderSystem::SetDeriveDepthBias( bool derive, float baseValue, float multiplier )
	{
		static_cast<Ogre::RenderSystem*>(_native)->setDeriveDepthBias( derive, baseValue, multiplier );
	}
	void RenderSystem::SetDeriveDepthBias( bool derive, float baseValue )
	{
		static_cast<Ogre::RenderSystem*>(_native)->setDeriveDepthBias( derive, baseValue );
	}
	void RenderSystem::SetDeriveDepthBias( bool derive )
	{
		static_cast<Ogre::RenderSystem*>(_native)->setDeriveDepthBias( derive );
	}
	
	void RenderSystem::_setRenderTarget( Mogre::RenderTarget^ target )
	{
		static_cast<Ogre::RenderSystem*>(_native)->_setRenderTarget( target );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RenderSystem(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RenderSystem(pClrObj);
	}
