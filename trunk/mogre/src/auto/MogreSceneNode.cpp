...
namespace Mogre
{
	...
	void SceneNode::_Init_CLRObject( )
	{
		static_cast<Ogre::SceneNode*>(_native)->_Init_CLRObject( );
	}
	...
	{
		static_cast<Ogre::SceneNode*>(_native)->hideBoundingBox( bHide );
	}
	...
	void SceneNode::FindLights( Mogre::LightList^ destList, Mogre::Real radius, Mogre::uint32 lightMask )
	{
		static_cast<const Ogre::SceneNode*>(_native)->findLights( destList, radius, lightMask );
	}
	...
	{
		static_cast<Ogre::SceneNode*>(_native)->setDebugDisplayEnabled( enabled, cascade );
	}
	void SceneNode::SetDebugDisplayEnabled( bool enabled )
	{
		static_cast<Ogre::SceneNode*>(_native)->setDebugDisplayEnabled( enabled );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_SceneNode(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::SceneNode(pClrObj);
	}
