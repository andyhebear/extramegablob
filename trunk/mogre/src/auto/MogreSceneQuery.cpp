...
namespace Mogre
{
	...
	void SceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::SceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_SceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::SceneQuery(pClrObj);
	}
	...
	void RegionSceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::RegionSceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RegionSceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RegionSceneQuery(pClrObj);
	}
	...
	void AxisAlignedBoxSceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::AxisAlignedBoxSceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_AxisAlignedBoxSceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::AxisAlignedBoxSceneQuery(pClrObj);
	}
	...
	void SphereSceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::SphereSceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_SphereSceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::SphereSceneQuery(pClrObj);
	}
	...
	//Public Declarations
	void PlaneBoundedVolumeListSceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::PlaneBoundedVolumeListSceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_PlaneBoundedVolumeListSceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::PlaneBoundedVolumeListSceneQuery(pClrObj);
	}
	...
	void RaySceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::RaySceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_RaySceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::RaySceneQuery(pClrObj);
	}
	...
	void IntersectionSceneQuery::_Init_CLRObject( )
	{
		static_cast<Ogre::IntersectionSceneQuery*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_IntersectionSceneQuery(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::IntersectionSceneQuery(pClrObj);
	}
