...
namespace Mogre
{
	...
	CLRHandle SimpleSpline::_CLRHandle::get()
	{
		return static_cast<Ogre::SimpleSpline*>(_native)->_CLRHandle;
	}
	void SimpleSpline::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::SimpleSpline*>(_native)->_CLRHandle = value;
	}
	...
	{
		return static_cast<const Ogre::SimpleSpline*>(_native)->interpolate( t );
	}
	
	Mogre::Vector3 SimpleSpline::Interpolate( unsigned int fromIndex, Mogre::Real t )
	{
		return static_cast<const Ogre::SimpleSpline*>(_native)->interpolate( fromIndex, t );
	}
