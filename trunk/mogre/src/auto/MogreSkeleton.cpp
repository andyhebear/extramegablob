...
namespace Mogre
{
	...
	void Skeleton::_Init_CLRObject( )
	{
		static_cast<Ogre::Skeleton*>(_native)->_Init_CLRObject( );
	}
	...
	bool Skeleton::HasBone( String^ name )
	{
		DECLARE_NATIVE_STRING( o_name, name )
	
		return static_cast<const Ogre::Skeleton*>(_native)->hasBone( o_name );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Skeleton(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Skeleton(pClrObj);
	}
