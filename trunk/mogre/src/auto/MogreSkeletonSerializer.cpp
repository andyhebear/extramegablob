...
namespace Mogre
{
	...
	void SkeletonSerializer::_Init_CLRObject( )
	{
		static_cast<Ogre::SkeletonSerializer*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_SkeletonSerializer(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::SkeletonSerializer(pClrObj);
	}
