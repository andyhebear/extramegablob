...
namespace Mogre
{
	...
	//Public Declarations
	StaticGeometry::LODBucket::LODBucket( Mogre::StaticGeometry::Region^ parent, unsigned short lod, Mogre::Real lodValue )
	{
		_createdByCLR = true;
		_native = new Ogre::StaticGeometry::LODBucket( parent, lod, lodValue);
	
		_native->_CLRHandle._MapToCLRObject(this, System::Runtime::InteropServices::GCHandleType::Normal);
	}
	
	CLRHandle StaticGeometry::LODBucket::_CLRHandle::get()
	{
		return static_cast<Ogre::StaticGeometry::LODBucket*>(_native)->_CLRHandle;
	}
	void StaticGeometry::LODBucket::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::StaticGeometry::LODBucket*>(_native)->_CLRHandle = value;
	}
	
	Mogre::EdgeData^ StaticGeometry::LODBucket::EdgeList::get()
	{
		return static_cast<const Ogre::StaticGeometry::LODBucket*>(_native)->getEdgeList( );
	}
	
	bool StaticGeometry::LODBucket::IsVertexProgramInUse::get()
	{
		return static_cast<const Ogre::StaticGeometry::LODBucket*>(_native)->isVertexProgramInUse( );
	}
	...
	Mogre::Real StaticGeometry::LODBucket::LodValue::get()
	{
		return static_cast<const Ogre::StaticGeometry::LODBucket*>(_native)->getLodValue( );
	}
	...
	void StaticGeometry::LODBucket::AddRenderables( Mogre::RenderQueue^ queue, Mogre::uint8 group, Mogre::Real lodValue )
	{
		static_cast<Ogre::StaticGeometry::LODBucket*>(_native)->addRenderables( queue, group, lodValue );
	}
	...
	Mogre::ShadowCaster::ShadowRenderableList^ StaticGeometry::LODBucket::GetShadowRenderableList( )
	{
		return static_cast<Ogre::StaticGeometry::LODBucket*>(_native)->getShadowRenderableList( );
	}
	
	void StaticGeometry::LODBucket::UpdateShadowRenderables( Mogre::ShadowTechnique shadowTechnique, Mogre::Vector4 lightPos, Mogre::HardwareIndexBufferSharedPtr^ indexBuffer, bool extrudeVertices, Mogre::Real extrusionDistance, unsigned long flags )
	{
		static_cast<Ogre::StaticGeometry::LODBucket*>(_native)->updateShadowRenderables( (Ogre::ShadowTechnique)shadowTechnique, lightPos, (Ogre::HardwareIndexBufferSharedPtr*)indexBuffer, extrudeVertices, extrusionDistance, flags );
	}
	void StaticGeometry::LODBucket::UpdateShadowRenderables( Mogre::ShadowTechnique shadowTechnique, Mogre::Vector4 lightPos, Mogre::HardwareIndexBufferSharedPtr^ indexBuffer, bool extrudeVertices, Mogre::Real extrusionDistance )
	{
		static_cast<Ogre::StaticGeometry::LODBucket*>(_native)->updateShadowRenderables( (Ogre::ShadowTechnique)shadowTechnique, lightPos, (Ogre::HardwareIndexBufferSharedPtr*)indexBuffer, extrudeVertices, extrusionDistance );
	}
	...
	CLRHandle StaticGeometry::MaterialBucket::_CLRHandle::get()
	{
		return static_cast<Ogre::StaticGeometry::MaterialBucket*>(_native)->_CLRHandle;
	}
	void StaticGeometry::MaterialBucket::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::StaticGeometry::MaterialBucket*>(_native)->_CLRHandle = value;
	}
	...
	void StaticGeometry::MaterialBucket::AddRenderables( Mogre::RenderQueue^ queue, Mogre::uint8 group, Mogre::Real lodValue )
	{
		static_cast<Ogre::StaticGeometry::MaterialBucket*>(_native)->addRenderables( queue, group, lodValue );
	}
	...
	void StaticGeometry::Region::_Init_CLRObject( )
	{
		static_cast<Ogre::StaticGeometry::Region*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_StaticGeometry_Region(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::StaticGeometry::Region(pClrObj);
	}
	...
	Mogre::uint32 StaticGeometry::VisibilityFlags::get()
	{
		return static_cast<const Ogre::StaticGeometry*>(_native)->getVisibilityFlags( );
	}
	void StaticGeometry::VisibilityFlags::set( Mogre::uint32 flags )
	{
		static_cast<Ogre::StaticGeometry*>(_native)->setVisibilityFlags( flags );
	}
	
	void StaticGeometry::_Init_CLRObject( )
	{
		static_cast<Ogre::StaticGeometry*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_StaticGeometry(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::StaticGeometry(pClrObj);
	}
