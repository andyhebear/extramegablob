...
namespace Mogre
{
	...
	Mogre::Vector2 StringConverter::ParseVector2( String^ val )
	{
		DECLARE_NATIVE_STRING( o_val, val )
	
		return Ogre::StringConverter::parseVector2( o_val );
	}
	...
	Mogre::Vector4 StringConverter::ParseVector4( String^ val )
	{
		DECLARE_NATIVE_STRING( o_val, val )
	
		return Ogre::StringConverter::parseVector4( o_val );
	}
