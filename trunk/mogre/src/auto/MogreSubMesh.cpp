...
namespace Mogre
{
	...
	CPP_DECLARE_STLVECTOR( SubMesh::, PointList, STLDECL_MANAGEDTYPE, STLDECL_NATIVETYPE )
	#undef STLDECL_MANAGEDTYPE
	#undef STLDECL_NATIVETYPE
	...
	CLRHandle SubMesh::_CLRHandle::get()
	{
		return static_cast<Ogre::SubMesh*>(_native)->_CLRHandle;
	}
	void SubMesh::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::SubMesh*>(_native)->_CLRHandle = value;
	}
	...
	Mogre::SubMesh::PointList^ SubMesh::extremityPoints::get()
	{
	...
	bool SubMesh::IsBuildEdgesEnabled::get()
	{
		return static_cast<const Ogre::SubMesh*>(_native)->isBuildEdgesEnabled( );
	}
	...
	void SubMesh::SetMaterialName( String^ matName, String^ groupName )
	{
		DECLARE_NATIVE_STRING( o_matName, matName )
		DECLARE_NATIVE_STRING( o_groupName, groupName )
	
		static_cast<Ogre::SubMesh*>(_native)->setMaterialName( o_matName, o_groupName );
	}
	void SubMesh::SetMaterialName( String^ matName )
	{
		DECLARE_NATIVE_STRING( o_matName, matName )
	...
	Mogre::SubMesh::Const_VertexBoneAssignmentList^ SubMesh::GetBoneAssignments( )
	{
		return static_cast<Ogre::SubMesh*>(_native)->getBoneAssignments( );
	}
	...
	{
		static_cast<Ogre::SubMesh*>(_native)->setBuildEdgesEnabled( b );
	}
