...
namespace Mogre
{
	...
	void TagPoint::_Init_CLRObject( )
	{
		static_cast<Ogre::TagPoint*>(_native)->_Init_CLRObject( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_TagPoint(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::TagPoint(pClrObj);
	}
