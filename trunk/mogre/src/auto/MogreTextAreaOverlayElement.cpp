...
namespace Mogre
{
	...
	void TextAreaOverlayElement::_Init_CLRObject( )
	{
		static_cast<Ogre::TextAreaOverlayElement*>(_native)->_Init_CLRObject( );
	}
	...
	Mogre::MaterialPtr^ TextAreaOverlayElement::GetMaterial( )
	{
		return static_cast<const Ogre::TextAreaOverlayElement*>(_native)->getMaterial( );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_TextAreaOverlayElement(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::TextAreaOverlayElement(pClrObj);
	}
