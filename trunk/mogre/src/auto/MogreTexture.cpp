...
namespace Mogre
{
	...
	Mogre::uint Texture::FSAA::get()
	{
		return static_cast<const Ogre::Texture*>(_native)->getFSAA( );
	}
	
	String^ Texture::FSAAHint::get()
	{
		return TO_CLR_STRING( static_cast<const Ogre::Texture*>(_native)->getFSAAHint( ) );
	}
	...
	bool Texture::IsHardwareGammaEnabled::get()
	{
		return static_cast<const Ogre::Texture*>(_native)->isHardwareGammaEnabled( );
	}
	...
	void Texture::_Init_CLRObject( )
	{
		static_cast<Ogre::Texture*>(_native)->_Init_CLRObject( );
	}
	
	void Texture::SetHardwareGammaEnabled( bool enabled )
	{
		static_cast<Ogre::Texture*>(_native)->setHardwareGammaEnabled( enabled );
	}
	
	void Texture::SetFSAA( Mogre::uint fsaa, String^ fsaaHint )
	{
		DECLARE_NATIVE_STRING( o_fsaaHint, fsaaHint )
	
		static_cast<Ogre::Texture*>(_native)->setFSAA( fsaa, o_fsaaHint );
	}
	...
	void Texture::ConvertToImage( Mogre::Image^ destImage, bool includeMipMaps )
	{
		static_cast<Ogre::Texture*>(_native)->convertToImage( destImage, includeMipMaps );
	}
	void Texture::ConvertToImage( Mogre::Image^ destImage )
	{
		static_cast<Ogre::Texture*>(_native)->convertToImage( destImage );
	}
	...
	__declspec(dllexport) void _Init_CLRObject_Texture(CLRObject* pClrObj)
	{
		*pClrObj = gcnew Mogre::Texture(pClrObj);
	}
