...
namespace Mogre
{
	...
	CLRHandle TextureUnitState::_CLRHandle::get()
	{
		return static_cast<Ogre::TextureUnitState*>(_native)->_CLRHandle;
	}
	void TextureUnitState::_CLRHandle::set( CLRHandle value )
	{
		static_cast<Ogre::TextureUnitState*>(_native)->_CLRHandle = value;
	}
	...
	bool TextureUnitState::IsHardwareGammaEnabled::get()
	{
		return static_cast<const Ogre::TextureUnitState*>(_native)->isHardwareGammaEnabled( );
	}
	...
	String^ TextureUnitState::ReferencedCompositorName::get()
	{
		return TO_CLR_STRING( static_cast<const Ogre::TextureUnitState*>(_native)->getReferencedCompositorName( ) );
	}
	
	size_t TextureUnitState::ReferencedMRTIndex::get()
	{
		return static_cast<const Ogre::TextureUnitState*>(_native)->getReferencedMRTIndex( );
	}
	
	String^ TextureUnitState::ReferencedTextureName::get()
	{
		return TO_CLR_STRING( static_cast<const Ogre::TextureUnitState*>(_native)->getReferencedTextureName( ) );
	}
	...
	void TextureUnitState::SetHardwareGammaEnabled( bool enabled )
	{
		static_cast<Ogre::TextureUnitState*>(_native)->setHardwareGammaEnabled( enabled );
	}
	...
	void TextureUnitState::SetCompositorReference( String^ compositorName, String^ textureName, size_t mrtIndex )
	{
		DECLARE_NATIVE_STRING( o_compositorName, compositorName )
		DECLARE_NATIVE_STRING( o_textureName, textureName )
	
		static_cast<Ogre::TextureUnitState*>(_native)->setCompositorReference( o_compositorName, o_textureName, mrtIndex );
	}
	void TextureUnitState::SetCompositorReference( String^ compositorName, String^ textureName )
	{
		DECLARE_NATIVE_STRING( o_compositorName, compositorName )
		DECLARE_NATIVE_STRING( o_textureName, textureName )
	
		static_cast<Ogre::TextureUnitState*>(_native)->setCompositorReference( o_compositorName, o_textureName );
	}
	
	void TextureUnitState::_prepare( )
	{
		static_cast<Ogre::TextureUnitState*>(_native)->_prepare( );
	}
	
	void TextureUnitState::_unprepare( )
	{
		static_cast<Ogre::TextureUnitState*>(_native)->_unprepare( );
	}
