...
//PINVOKE WRAPPER
EXPORT void MeshManager_SetSkydomeFadingParameters(SkyX::MeshManager* ptr,bool smoothSkydomeFading, float skydomeFadingPercent)
{
	ptr->setSkydomeFadingParameters(smoothSkydomeFading,skydomeFadingPercent);
}

EXPORT bool MeshManager_GetSmoothSkydomeFading(SkyX::MeshManager* ptr)
{
	return ptr->getSmoothSkydomeFading();
}


EXPORT float MeshManager_GetSkydomeFadingPercent(SkyX::MeshManager* ptr)
{
	return ptr->getSkydomeFadingPercent();
}


EXPORT int MeshManager_GetSteps(SkyX::MeshManager* ptr)
{
	return ptr->getSteps();
}

EXPORT int MeshManager_GetCircles(SkyX::MeshManager* ptr)
{
	return ptr->getCircles();
}

EXPORT float MeshManager_GetSkydomeRadius(SkyX::MeshManager* ptr)
{
	return ptr->getSkydomeRadius();
}

EXPORT void MeshManager_SetGeometryParameters(SkyX::MeshManager* ptr,int steps, int circles)
{
	ptr->_setGeometryParameters(steps,circles);
}

EXPORT char* MeshManager_GetMaterialName(SkyX::MeshManager* ptr)
{
	return CreateOutString( ptr->getMaterialName() );
}

EXPORT void MeshManager_SetMaterialName(SkyX::MeshManager* ptr,char* name)
{
